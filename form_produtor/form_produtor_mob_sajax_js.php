  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_produtor_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_produtor_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_pessoa
  function do_ajax_form_produtor_mob_validate_id_pessoa()
  {
    var nomeCampo_id_pessoa = "id_pessoa";
    var var_id_pessoa = scAjaxGetFieldHidden(nomeCampo_id_pessoa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_id_pessoa(var_id_pessoa, var_script_case_init, do_ajax_form_produtor_mob_validate_id_pessoa_cb);
  } // do_ajax_form_produtor_mob_validate_id_pessoa

  function do_ajax_form_produtor_mob_validate_id_pessoa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_pessoa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_id_pessoa_cb

  // ---------- Validate cnpj
  function do_ajax_form_produtor_mob_validate_cnpj()
  {
    var nomeCampo_cnpj = "cnpj";
    var var_cnpj = scAjaxGetFieldText(nomeCampo_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_cnpj(var_cnpj, var_script_case_init, do_ajax_form_produtor_mob_validate_cnpj_cb);
  } // do_ajax_form_produtor_mob_validate_cnpj

  function do_ajax_form_produtor_mob_validate_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cnpj";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_cnpj_cb

  // ---------- Validate nome_pessoa
  function do_ajax_form_produtor_mob_validate_nome_pessoa()
  {
    var nomeCampo_nome_pessoa = "nome_pessoa";
    var var_nome_pessoa = scAjaxGetFieldText(nomeCampo_nome_pessoa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_nome_pessoa(var_nome_pessoa, var_script_case_init, do_ajax_form_produtor_mob_validate_nome_pessoa_cb);
  } // do_ajax_form_produtor_mob_validate_nome_pessoa

  function do_ajax_form_produtor_mob_validate_nome_pessoa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome_pessoa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_nome_pessoa_cb

  // ---------- Validate razao_social
  function do_ajax_form_produtor_mob_validate_razao_social()
  {
    var nomeCampo_razao_social = "razao_social";
    var var_razao_social = scAjaxGetFieldText(nomeCampo_razao_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_razao_social(var_razao_social, var_script_case_init, do_ajax_form_produtor_mob_validate_razao_social_cb);
  } // do_ajax_form_produtor_mob_validate_razao_social

  function do_ajax_form_produtor_mob_validate_razao_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_razao_social_cb

  // ---------- Validate cep
  function do_ajax_form_produtor_mob_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_cep(var_cep, var_script_case_init, do_ajax_form_produtor_mob_validate_cep_cb);
  } // do_ajax_form_produtor_mob_validate_cep

  function do_ajax_form_produtor_mob_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_cep_cb

  // ---------- Validate endereco
  function do_ajax_form_produtor_mob_validate_endereco()
  {
    var nomeCampo_endereco = "endereco";
    var var_endereco = scAjaxGetFieldText(nomeCampo_endereco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_endereco(var_endereco, var_script_case_init, do_ajax_form_produtor_mob_validate_endereco_cb);
  } // do_ajax_form_produtor_mob_validate_endereco

  function do_ajax_form_produtor_mob_validate_endereco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_endereco_cb

  // ---------- Validate num
  function do_ajax_form_produtor_mob_validate_num()
  {
    var nomeCampo_num = "num";
    var var_num = scAjaxGetFieldText(nomeCampo_num);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_num(var_num, var_script_case_init, do_ajax_form_produtor_mob_validate_num_cb);
  } // do_ajax_form_produtor_mob_validate_num

  function do_ajax_form_produtor_mob_validate_num_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "num";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_num_cb

  // ---------- Validate complemento
  function do_ajax_form_produtor_mob_validate_complemento()
  {
    var nomeCampo_complemento = "complemento";
    var var_complemento = scAjaxGetFieldText(nomeCampo_complemento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_complemento(var_complemento, var_script_case_init, do_ajax_form_produtor_mob_validate_complemento_cb);
  } // do_ajax_form_produtor_mob_validate_complemento

  function do_ajax_form_produtor_mob_validate_complemento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_complemento_cb

  // ---------- Validate bairro
  function do_ajax_form_produtor_mob_validate_bairro()
  {
    var nomeCampo_bairro = "bairro";
    var var_bairro = scAjaxGetFieldText(nomeCampo_bairro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_bairro(var_bairro, var_script_case_init, do_ajax_form_produtor_mob_validate_bairro_cb);
  } // do_ajax_form_produtor_mob_validate_bairro

  function do_ajax_form_produtor_mob_validate_bairro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bairro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_bairro_cb

  // ---------- Validate cidade
  function do_ajax_form_produtor_mob_validate_cidade()
  {
    var nomeCampo_cidade = "cidade";
    var var_cidade = scAjaxGetFieldText(nomeCampo_cidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_cidade(var_cidade, var_script_case_init, do_ajax_form_produtor_mob_validate_cidade_cb);
  } // do_ajax_form_produtor_mob_validate_cidade

  function do_ajax_form_produtor_mob_validate_cidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cidade";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_cidade_cb

  // ---------- Validate uf
  function do_ajax_form_produtor_mob_validate_uf()
  {
    var nomeCampo_uf = "uf";
    var var_uf = scAjaxGetFieldText(nomeCampo_uf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_uf(var_uf, var_script_case_init, do_ajax_form_produtor_mob_validate_uf_cb);
  } // do_ajax_form_produtor_mob_validate_uf

  function do_ajax_form_produtor_mob_validate_uf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uf";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_uf_cb

  // ---------- Validate telefone
  function do_ajax_form_produtor_mob_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_produtor_mob_validate_telefone_cb);
  } // do_ajax_form_produtor_mob_validate_telefone

  function do_ajax_form_produtor_mob_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_telefone_cb

  // ---------- Validate celular
  function do_ajax_form_produtor_mob_validate_celular()
  {
    var nomeCampo_celular = "celular";
    var var_celular = scAjaxGetFieldText(nomeCampo_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_celular(var_celular, var_script_case_init, do_ajax_form_produtor_mob_validate_celular_cb);
  } // do_ajax_form_produtor_mob_validate_celular

  function do_ajax_form_produtor_mob_validate_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "celular";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_celular_cb

  // ---------- Validate email
  function do_ajax_form_produtor_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_email(var_email, var_script_case_init, do_ajax_form_produtor_mob_validate_email_cb);
  } // do_ajax_form_produtor_mob_validate_email

  function do_ajax_form_produtor_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_email_cb

  // ---------- Validate site
  function do_ajax_form_produtor_mob_validate_site()
  {
    var nomeCampo_site = "site";
    var var_site = scAjaxGetFieldText(nomeCampo_site);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_site(var_site, var_script_case_init, do_ajax_form_produtor_mob_validate_site_cb);
  } // do_ajax_form_produtor_mob_validate_site

  function do_ajax_form_produtor_mob_validate_site_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "site";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_site_cb

  // ---------- Validate ie
  function do_ajax_form_produtor_mob_validate_ie()
  {
    var nomeCampo_ie = "ie";
    var var_ie = scAjaxGetFieldText(nomeCampo_ie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_ie(var_ie, var_script_case_init, do_ajax_form_produtor_mob_validate_ie_cb);
  } // do_ajax_form_produtor_mob_validate_ie

  function do_ajax_form_produtor_mob_validate_ie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ie";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_ie_cb

  // ---------- Validate observacao
  function do_ajax_form_produtor_mob_validate_observacao()
  {
    var nomeCampo_observacao = "observacao";
    var var_observacao = scAjaxGetFieldText(nomeCampo_observacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_observacao(var_observacao, var_script_case_init, do_ajax_form_produtor_mob_validate_observacao_cb);
  } // do_ajax_form_produtor_mob_validate_observacao

  function do_ajax_form_produtor_mob_validate_observacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_observacao_cb

  // ---------- Validate ibge
  function do_ajax_form_produtor_mob_validate_ibge()
  {
    var nomeCampo_ibge = "ibge";
    var var_ibge = scAjaxGetFieldText(nomeCampo_ibge);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_ibge(var_ibge, var_script_case_init, do_ajax_form_produtor_mob_validate_ibge_cb);
  } // do_ajax_form_produtor_mob_validate_ibge

  function do_ajax_form_produtor_mob_validate_ibge_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ibge";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_ibge_cb

  // ---------- Validate regiao
  function do_ajax_form_produtor_mob_validate_regiao()
  {
    var nomeCampo_regiao = "regiao";
    var var_regiao = scAjaxGetFieldText(nomeCampo_regiao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_regiao(var_regiao, var_script_case_init, do_ajax_form_produtor_mob_validate_regiao_cb);
  } // do_ajax_form_produtor_mob_validate_regiao

  function do_ajax_form_produtor_mob_validate_regiao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "regiao";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_regiao_cb

  // ---------- Validate produto
  function do_ajax_form_produtor_mob_validate_produto()
  {
    var nomeCampo_produto = "produto";
    var var_produto = scAjaxGetFieldText(nomeCampo_produto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_mob_validate_produto(var_produto, var_script_case_init, do_ajax_form_produtor_mob_validate_produto_cb);
  } // do_ajax_form_produtor_mob_validate_produto

  function do_ajax_form_produtor_mob_validate_produto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "produto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_mob_validate_produto_cb

  // ---------- Event onchange cep
  function do_ajax_form_produtor_mob_event_cep_onchange()
  {
    ...
    var var_ibge = scAjaxGetFieldText("ibge");
    var var_regiao = scAjaxGetFieldText("regiao");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_produtor_mob_event_cep_onchange(var_cep, var_endereco, var_complemento, var_bairro, var_cidade, var_uf, var_ibge, var_regiao, var_script_case_init, do_ajax_form_produtor_mob_event_cep_onchange_cb);
  } // do_ajax_form_produtor_mob_event_cep_onchange

  function do_ajax_form_produtor_mob_event_cep_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cep";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_produtor_mob_event_cep_onchange_cb_after_alert);
  } // do_ajax_form_produtor_mob_event_cep_onchange_cb
  function do_ajax_form_produtor_mob_event_cep_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_produtor_mob_event_cep_onchange_cb_after_alert

  // ---------- Event onchange cnpj
  function do_ajax_form_produtor_mob_event_cnpj_onchange()
  {
    var var_cnpj = scAjaxGetFieldText("cnpj");
    var var_razao_social = scAjaxGetFieldText("razao_social");
    var var_nome_pessoa = scAjaxGetFieldText("nome_pessoa");
    var var_cep = scAjaxGetFieldText("cep");
    var var_endereco = scAjaxGetFieldText("endereco");
    var var_num = scAjaxGetFieldText("num");
    var var_complemento = scAjaxGetFieldText("complemento");
    var var_bairro = scAjaxGetFieldText("bairro");
    var var_cidade = scAjaxGetFieldText("cidade");
    var var_uf = scAjaxGetFieldText("uf");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_produtor_mob_event_cnpj_onchange(var_cnpj, var_razao_social, var_nome_pessoa, var_cep, var_endereco, var_num, var_complemento, var_bairro, var_cidade, var_uf, var_telefone, var_email, var_script_case_init, do_ajax_form_produtor_mob_event_cnpj_onchange_cb);
  } // do_ajax_form_produtor_mob_event_cnpj_onchange

  function do_ajax_form_produtor_mob_event_cnpj_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cnpj";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_produtor_mob_event_cnpj_onchange_cb_after_alert);
  } // do_ajax_form_produtor_mob_event_cnpj_onchange_cb
  function do_ajax_form_produtor_mob_event_cnpj_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_produtor_mob_event_cnpj_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_produtor_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_produtor_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_pessoa = scAjaxGetFieldHidden("id_pessoa");
    var var_cnpj = scAjaxGetFieldText("cnpj");
    var var_nome_pessoa = scAjaxGetFieldText("nome_pessoa");
    var var_razao_social = scAjaxGetFieldText("razao_social");
    var var_cep = scAjaxGetFieldText("cep");
    ...
    var var_email = scAjaxGetFieldText("email");
    var var_site = scAjaxGetFieldText("site");
    var var_ie = scAjaxGetFieldText("ie");
    ...
    scAjaxProcOn();
    x_ajax_form_produtor_mob_submit_form(var_id_pessoa, var_cnpj, var_nome_pessoa, var_razao_social, var_cep, var_endereco, var_num, var_complemento, var_bairro, var_cidade, var_uf, var_telefone, var_celular, var_email, var_site, var_ie, var_observacao, var_ibge, var_regiao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_produtor_mob_submit_form_cb);
  } // do_ajax_form_produtor_mob_submit_form

  function do_ajax_form_produtor_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_produtor_mob_submit_form_cb_after_alert);
  } // do_ajax_form_produtor_mob_submit_form_cb
  function do_ajax_form_produtor_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_produtor_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_produtor_produto_mob"] = "off";

  function do_ajax_form_produtor_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_produtor_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_produtor_mob_navigate_form();
    }
  }

  function perform_ajax_form_produtor_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_id_pessoa = document.F2.id_pessoa.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_produtor_produto_mob"] = "on";
    x_ajax_form_produtor_mob_navigate_form(var_id_pessoa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_produtor_mob_navigate_form_cb);
  } // do_ajax_form_produtor_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_produtor_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_produtor_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_pessoa.value = scAjaxGetKeyValue("id_pessoa");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_produtor_produto_mob"] && "nmsc_iframe_liga_form_produtor_produto_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_produtor_produto_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_produtor_produto_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_produtor_produto_mob').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_produtor_produto_mob').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_produtor_produto_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_produtor_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_produtor_mob_navigate_form_cb
  function do_ajax_form_produtor_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_produtor_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_produtor_mob_navigate_form_cb_after_alert

  function sc_hide_form_produtor_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_produtor_produto_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "id_pessoa";
  ajax_field_list[1] = "cnpj";
  ajax_field_list[2] = "nome_pessoa";
  ajax_field_list[3] = "razao_social";
  ajax_field_list[4] = "cep";
  ajax_field_list[5] = "endereco";
  ajax_field_list[6] = "num";
  ajax_field_list[7] = "complemento";
  ajax_field_list[8] = "bairro";
  ajax_field_list[9] = "cidade";
  ajax_field_list[10] = "uf";
  ajax_field_list[11] = "telefone";
  ajax_field_list[12] = "celular";
  ajax_field_list[13] = "email";
  ajax_field_list[14] = "site";
  ajax_field_list[15] = "ie";
  ajax_field_list[16] = "observacao";
  ajax_field_list[17] = "ibge";
  ajax_field_list[18] = "regiao";
  ajax_field_list[19] = "produto";
  ...
  var ajax_error_list = {
    "id_pessoa": {"label": "#", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cnpj": {"label": "CNPJ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "nome_pessoa": {"label": "Nome", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "razao_social": {"label": "Razão Social", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cep": {"label": "CEP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "endereco": {"label": "Endereço", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "num": {"label": "Num", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "complemento": {"label": "Complemento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "bairro": {"label": "Bairro", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "cidade": {"label": "Cidade", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "uf": {"label": "UF", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "telefone": {"label": "Telefone", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "celular": {"label": "Celular", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "email": {"label": "Email", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "site": {"label": "Site", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ie": {"label": "IE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "observacao": {"label": "Observação", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "ibge": {"label": "IBGE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "regiao": {"label": "Região", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "produto": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  ajax_field_mult["site"][1] = "site";
  ajax_field_mult["ie"][1] = "ie";
  ajax_field_mult["observacao"][1] = "observacao";
  ajax_field_mult["ibge"][1] = "ibge";
  ajax_field_mult["regiao"][1] = "regiao";
  ajax_field_mult["produto"][1] = "produto";

  var ajax_field_id = {
    "id_pessoa": new Array("hidden_field_label_id_pessoa", "hidden_field_data_id_pessoa"),
    "cnpj": new Array("hidden_field_label_cnpj", "hidden_field_data_cnpj"),
    "nome_pessoa": new Array("hidden_field_label_nome_pessoa", "hidden_field_data_nome_pessoa"),
    ...
    "num": new Array("hidden_field_label_num", "hidden_field_data_num"),
    ...
    "site": new Array("hidden_field_label_site", "hidden_field_data_site"),
    ...
    "ibge": new Array("hidden_field_label_ibge", "hidden_field_data_ibge"),
    "regiao": new Array("hidden_field_label_regiao", "hidden_field_data_regiao"),
    "produto": new Array("hidden_field_label_produto", "hidden_field_data_produto")
  };
