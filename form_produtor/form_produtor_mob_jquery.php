...
function displayChange_field_produto(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_produtor_produto_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_produtor_produto_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_produtor_mob_form" + pageNo).hide();
}
...
?>
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_produtor_mob_validate_insert_data(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_produtor_mob_validate_update_data(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_produtor_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
