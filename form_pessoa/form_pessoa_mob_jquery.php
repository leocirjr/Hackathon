...
function scHidePage(pageNo) {
	$("#id_form_pessoa_mob_form" + pageNo).hide();
}
...
?>
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pessoa_mob_validate_insert_data(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pessoa_mob_validate_update_data(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_pessoa_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
