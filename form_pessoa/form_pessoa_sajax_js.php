  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pessoa" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_pessoa
  function do_ajax_form_pessoa_validate_id_pessoa()
  {
    var nomeCampo_id_pessoa = "id_pessoa";
    var var_id_pessoa = scAjaxGetFieldHidden(nomeCampo_id_pessoa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_id_pessoa(var_id_pessoa, var_script_case_init, do_ajax_form_pessoa_validate_id_pessoa_cb);
  } // do_ajax_form_pessoa_validate_id_pessoa

  function do_ajax_form_pessoa_validate_id_pessoa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_id_pessoa_cb

  // ---------- Validate cnpj
  function do_ajax_form_pessoa_validate_cnpj()
  {
    var nomeCampo_cnpj = "cnpj";
    var var_cnpj = scAjaxGetFieldText(nomeCampo_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_cnpj(var_cnpj, var_script_case_init, do_ajax_form_pessoa_validate_cnpj_cb);
  } // do_ajax_form_pessoa_validate_cnpj

  function do_ajax_form_pessoa_validate_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cnpj";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_cnpj_cb

  // ---------- Validate nome_pessoa
  function do_ajax_form_pessoa_validate_nome_pessoa()
  {
    var nomeCampo_nome_pessoa = "nome_pessoa";
    var var_nome_pessoa = scAjaxGetFieldText(nomeCampo_nome_pessoa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_nome_pessoa(var_nome_pessoa, var_script_case_init, do_ajax_form_pessoa_validate_nome_pessoa_cb);
  } // do_ajax_form_pessoa_validate_nome_pessoa

  function do_ajax_form_pessoa_validate_nome_pessoa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_nome_pessoa_cb

  // ---------- Validate razao_social
  function do_ajax_form_pessoa_validate_razao_social()
  {
    var nomeCampo_razao_social = "razao_social";
    var var_razao_social = scAjaxGetFieldText(nomeCampo_razao_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_razao_social(var_razao_social, var_script_case_init, do_ajax_form_pessoa_validate_razao_social_cb);
  } // do_ajax_form_pessoa_validate_razao_social

  function do_ajax_form_pessoa_validate_razao_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_razao_social_cb

  // ---------- Validate cep
  function do_ajax_form_pessoa_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_cep(var_cep, var_script_case_init, do_ajax_form_pessoa_validate_cep_cb);
  } // do_ajax_form_pessoa_validate_cep

  function do_ajax_form_pessoa_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_cep_cb

  // ---------- Validate endereco
  function do_ajax_form_pessoa_validate_endereco()
  {
    var nomeCampo_endereco = "endereco";
    var var_endereco = scAjaxGetFieldText(nomeCampo_endereco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_endereco(var_endereco, var_script_case_init, do_ajax_form_pessoa_validate_endereco_cb);
  } // do_ajax_form_pessoa_validate_endereco

  function do_ajax_form_pessoa_validate_endereco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_endereco_cb

  // ---------- Validate num
  function do_ajax_form_pessoa_validate_num()
  {
    var nomeCampo_num = "num";
    var var_num = scAjaxGetFieldText(nomeCampo_num);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_num(var_num, var_script_case_init, do_ajax_form_pessoa_validate_num_cb);
  } // do_ajax_form_pessoa_validate_num

  function do_ajax_form_pessoa_validate_num_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "num";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_num_cb

  // ---------- Validate complemento
  function do_ajax_form_pessoa_validate_complemento()
  {
    var nomeCampo_complemento = "complemento";
    var var_complemento = scAjaxGetFieldText(nomeCampo_complemento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_complemento(var_complemento, var_script_case_init, do_ajax_form_pessoa_validate_complemento_cb);
  } // do_ajax_form_pessoa_validate_complemento

  function do_ajax_form_pessoa_validate_complemento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_complemento_cb

  // ---------- Validate bairro
  function do_ajax_form_pessoa_validate_bairro()
  {
    var nomeCampo_bairro = "bairro";
    var var_bairro = scAjaxGetFieldText(nomeCampo_bairro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_bairro(var_bairro, var_script_case_init, do_ajax_form_pessoa_validate_bairro_cb);
  } // do_ajax_form_pessoa_validate_bairro

  function do_ajax_form_pessoa_validate_bairro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bairro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_bairro_cb

  // ---------- Validate cidade
  function do_ajax_form_pessoa_validate_cidade()
  {
    var nomeCampo_cidade = "cidade";
    var var_cidade = scAjaxGetFieldText(nomeCampo_cidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_cidade(var_cidade, var_script_case_init, do_ajax_form_pessoa_validate_cidade_cb);
  } // do_ajax_form_pessoa_validate_cidade

  function do_ajax_form_pessoa_validate_cidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cidade";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_cidade_cb

  // ---------- Validate uf
  function do_ajax_form_pessoa_validate_uf()
  {
    var nomeCampo_uf = "uf";
    var var_uf = scAjaxGetFieldText(nomeCampo_uf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_uf(var_uf, var_script_case_init, do_ajax_form_pessoa_validate_uf_cb);
  } // do_ajax_form_pessoa_validate_uf

  function do_ajax_form_pessoa_validate_uf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uf";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_uf_cb

  // ---------- Validate telefone
  function do_ajax_form_pessoa_validate_telefone()
  {
    var nomeCampo_telefone = "telefone";
    var var_telefone = scAjaxGetFieldText(nomeCampo_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_telefone(var_telefone, var_script_case_init, do_ajax_form_pessoa_validate_telefone_cb);
  } // do_ajax_form_pessoa_validate_telefone

  function do_ajax_form_pessoa_validate_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_telefone_cb

  // ---------- Validate celular
  function do_ajax_form_pessoa_validate_celular()
  {
    var nomeCampo_celular = "celular";
    var var_celular = scAjaxGetFieldText(nomeCampo_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_celular(var_celular, var_script_case_init, do_ajax_form_pessoa_validate_celular_cb);
  } // do_ajax_form_pessoa_validate_celular

  function do_ajax_form_pessoa_validate_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "celular";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_celular_cb

  // ---------- Validate email
  function do_ajax_form_pessoa_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_email(var_email, var_script_case_init, do_ajax_form_pessoa_validate_email_cb);
  } // do_ajax_form_pessoa_validate_email

  function do_ajax_form_pessoa_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_email_cb

  // ---------- Validate site
  function do_ajax_form_pessoa_validate_site()
  {
    var nomeCampo_site = "site";
    var var_site = scAjaxGetFieldText(nomeCampo_site);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_site(var_site, var_script_case_init, do_ajax_form_pessoa_validate_site_cb);
  } // do_ajax_form_pessoa_validate_site

  function do_ajax_form_pessoa_validate_site_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "site";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_site_cb

  // ---------- Validate ie
  function do_ajax_form_pessoa_validate_ie()
  {
    var nomeCampo_ie = "ie";
    var var_ie = scAjaxGetFieldText(nomeCampo_ie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_ie(var_ie, var_script_case_init, do_ajax_form_pessoa_validate_ie_cb);
  } // do_ajax_form_pessoa_validate_ie

  function do_ajax_form_pessoa_validate_ie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ie";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_ie_cb

  // ---------- Validate observacao
  function do_ajax_form_pessoa_validate_observacao()
  {
    var nomeCampo_observacao = "observacao";
    var var_observacao = scAjaxGetFieldText(nomeCampo_observacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_observacao(var_observacao, var_script_case_init, do_ajax_form_pessoa_validate_observacao_cb);
  } // do_ajax_form_pessoa_validate_observacao

  function do_ajax_form_pessoa_validate_observacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_observacao_cb

  // ---------- Validate login
  function do_ajax_form_pessoa_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldSelect(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pessoa_validate_login(var_login, var_script_case_init, do_ajax_form_pessoa_validate_login_cb);
  } // do_ajax_form_pessoa_validate_login

  function do_ajax_form_pessoa_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "login";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pessoa_validate_login_cb

  // ---------- Event onchange cnpj
  function do_ajax_form_pessoa_event_cnpj_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_pessoa_event_cnpj_onchange(var_cnpj, var_razao_social, var_nome_pessoa, var_cep, var_endereco, var_num, var_complemento, var_bairro, var_cidade, var_uf, var_telefone, var_email, var_script_case_init, do_ajax_form_pessoa_event_cnpj_onchange_cb);
  } // do_ajax_form_pessoa_event_cnpj_onchange

  function do_ajax_form_pessoa_event_cnpj_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cnpj";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pessoa_event_cnpj_onchange_cb_after_alert);
  } // do_ajax_form_pessoa_event_cnpj_onchange_cb
  function do_ajax_form_pessoa_event_cnpj_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pessoa_event_cnpj_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pessoa_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pessoa_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_pessoa_submit_form(var_id_pessoa, var_cnpj, var_nome_pessoa, var_razao_social, var_cep, var_endereco, var_num, var_complemento, var_bairro, var_cidade, var_uf, var_telefone, var_celular, var_email, var_site, var_ie, var_observacao, var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pessoa_submit_form_cb);
  } // do_ajax_form_pessoa_submit_form

  function do_ajax_form_pessoa_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pessoa_submit_form_cb_after_alert);
  } // do_ajax_form_pessoa_submit_form_cb
  function do_ajax_form_pessoa_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pessoa_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_pessoa_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_pessoa_navigate_form, function() {});
    } else {
      perform_ajax_form_pessoa_navigate_form();
    }
  }

  function perform_ajax_form_pessoa_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_pessoa_navigate_form(var_id_pessoa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pessoa_navigate_form_cb);
  } // do_ajax_form_pessoa_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pessoa']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pessoa_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pessoa_navigate_form_cb_after_alert);
  } // do_ajax_form_pessoa_navigate_form_cb
  function do_ajax_form_pessoa_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_pessoa_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_pessoa_navigate_form_cb_after_alert

  function sc_hide_form_pessoa_form()
  {
