...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_produto']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_produto']['opc_ant'] = "inicio";
      }
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_produto']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_produto']['label'] = "Produto";
      ...
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['buttonStatus'];
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['opc_ant'] : "";
      } 
...
//
      ...
      {
      $_SESSION['scriptcase']['form_produto']['contr_erro'] = 'on';
  ?>
...
$_SESSION['scriptcase']['form_produto']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_produto']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_produto']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->Field_no_validate = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Field_no_validate'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Field_no_validate'] : array();
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_produto.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_produto_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_produto"> 
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_produto']['keyVal'] = form_produto_pack_protect_string($this->nmgp_dados_form['id_produto']);
          }
   } // ajax_return_values
  ...
  {
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Field_no_validate'] = array();
      $this->nm_guardar_campos();
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['total']))
          {
               $sc_where_pos = " WHERE ((id_produto < $this->id_produto))";
               if ('' != $sc_where)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id_produto)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['opcao'] = '';
   ...
   { 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['parms'] = "id_produto?#?$this->id_produto?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['where_filter'])
      {
...
//---------- 
      ...
      { 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['ordem_ord'] == " desc") {
