  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_produto_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_produto
  function do_ajax_form_produto_mob_validate_id_produto()
  {
    var nomeCampo_id_produto = "id_produto";
    var var_id_produto = scAjaxGetFieldHidden(nomeCampo_id_produto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_id_produto(var_id_produto, var_script_case_init, do_ajax_form_produto_mob_validate_id_produto_cb);
  } // do_ajax_form_produto_mob_validate_id_produto

  function do_ajax_form_produto_mob_validate_id_produto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_id_produto_cb

  // ---------- Validate produto
  function do_ajax_form_produto_mob_validate_produto()
  {
    var nomeCampo_produto = "produto";
    var var_produto = scAjaxGetFieldText(nomeCampo_produto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_produto(var_produto, var_script_case_init, do_ajax_form_produto_mob_validate_produto_cb);
  } // do_ajax_form_produto_mob_validate_produto

  function do_ajax_form_produto_mob_validate_produto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "produto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_produto_cb

  // ---------- Validate descricao
  function do_ajax_form_produto_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_produto_mob_validate_descricao_cb);
  } // do_ajax_form_produto_mob_validate_descricao

  function do_ajax_form_produto_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_descricao_cb

  // ---------- Validate categoria
  function do_ajax_form_produto_mob_validate_categoria()
  {
    var nomeCampo_categoria = "categoria";
    var var_categoria = scAjaxGetFieldText(nomeCampo_categoria);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_categoria(var_categoria, var_script_case_init, do_ajax_form_produto_mob_validate_categoria_cb);
  } // do_ajax_form_produto_mob_validate_categoria

  function do_ajax_form_produto_mob_validate_categoria_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_categoria_cb

  // ---------- Validate tipo
  function do_ajax_form_produto_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldText(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_produto_mob_validate_tipo_cb);
  } // do_ajax_form_produto_mob_validate_tipo

  function do_ajax_form_produto_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_tipo_cb

  // ---------- Validate un
  function do_ajax_form_produto_mob_validate_un()
  {
    var nomeCampo_un = "un";
    var var_un = scAjaxGetFieldText(nomeCampo_un);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_un(var_un, var_script_case_init, do_ajax_form_produto_mob_validate_un_cb);
  } // do_ajax_form_produto_mob_validate_un

  function do_ajax_form_produto_mob_validate_un_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "un";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_un_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_produto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_produto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_produto = scAjaxGetFieldHidden("id_produto");
    var var_produto = scAjaxGetFieldText("produto");
    ...
    var var_un = scAjaxGetFieldText("un");
    ...
    scAjaxProcOn();
    x_ajax_form_produto_mob_submit_form(var_id_produto, var_produto, var_descricao, var_categoria, var_tipo, var_un, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_produto_mob_submit_form_cb);
  } // do_ajax_form_produto_mob_submit_form

  function do_ajax_form_produto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_produto_mob_submit_form_cb_after_alert);
  } // do_ajax_form_produto_mob_submit_form_cb
  function do_ajax_form_produto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_produto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_produto_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_produto_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_produto_mob_navigate_form();
    }
  }

  function perform_ajax_form_produto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    var var_id_produto = document.F2.id_produto.value;
    ...
    scAjaxProcOn();
    x_ajax_form_produto_mob_navigate_form(var_id_produto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_produto_mob_navigate_form_cb);
  } // do_ajax_form_produto_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_produto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_produto.value = scAjaxGetKeyValue("id_produto");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_produto_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_produto_mob_navigate_form_cb
  function do_ajax_form_produto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_produto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_produto_mob_navigate_form_cb_after_alert

  function sc_hide_form_produto_mob_form()
  {
  ...
  ajax_field_list[0] = "id_produto";
  ajax_field_list[1] = "produto";
  ajax_field_list[2] = "descricao";
  ajax_field_list[3] = "categoria";
  ajax_field_list[4] = "tipo";
  ajax_field_list[5] = "un";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_produto": {"label": "#", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "produto": {"label": "Produto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "descricao": {"label": "Descrição", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "categoria": {"label": "Categoria", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "tipo": {"label": "Tipo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0},
    "un": {"label": "UN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0}
  };
  ...
  var ajax_field_id = {
    ...
    "un": new Array("hidden_field_label_un", "hidden_field_data_un")
  };
