...
$_SESSION['scriptcase']['sec_grid_sec_users']['contr_erro'] = 'off'; 
   ...
   function NM_export_data_senha()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->data_senha) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->data_senha) . "\"";
         }
   }
   //----- data_expirar_senha
   function NM_export_data_expirar_senha()
   {
         ...
         {
             $SC_Label = "data_expirar_senha"; 
         }
         $this->clear_tag($SC_Label); 
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->data_expirar_senha) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->data_expirar_senha) . "\"";
         }
   }
