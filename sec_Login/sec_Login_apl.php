...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->usr_dtpsw) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['usr_dtpsw'] = $this->usr_dtpsw;
      }
      if (isset($this->usr_expsw) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['usr_expsw'] = $this->usr_expsw;
      }
      if (isset($this->config_logo_login) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['config_logo_login'] = $this->config_logo_login;
      }
      if (isset($this->config_logo_menu) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['config_logo_menu'] = $this->config_logo_menu;
      }
      if (isset($this->config_fundo_login) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['config_fundo_login'] = $this->config_fundo_login;
      }
      if (isset($this->config_fundo_menu) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['config_fundo_menu'] = $this->config_fundo_menu;
      }
      if (isset($this->config_cor) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['config_cor'] = $this->config_cor;
      }
      if (isset($this->config_smtp_server) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['config_smtp_server'] = $this->config_smtp_server;
      }
      if (isset($this->config_smtp_user) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['config_smtp_user'] = $this->config_smtp_user;
      }
      if (isset($this->config_smpt_pass) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['config_smpt_pass'] = $this->config_smpt_pass;
      }
      ...
      if (isset($_POST["usr_dtpsw"]) && isset($this->usr_dtpsw)) 
      {
          $_SESSION['usr_dtpsw'] = $this->usr_dtpsw;
      }
      if (isset($_POST["usr_expsw"]) && isset($this->usr_expsw)) 
      {
          $_SESSION['usr_expsw'] = $this->usr_expsw;
      }
      if (isset($_POST["config_logo_login"]) && isset($this->config_logo_login)) 
      {
          $_SESSION['config_logo_login'] = $this->config_logo_login;
      }
      if (isset($_POST["config_logo_menu"]) && isset($this->config_logo_menu)) 
      {
          $_SESSION['config_logo_menu'] = $this->config_logo_menu;
      }
      if (isset($_POST["config_fundo_login"]) && isset($this->config_fundo_login)) 
      {
          $_SESSION['config_fundo_login'] = $this->config_fundo_login;
      }
      if (isset($_POST["config_fundo_menu"]) && isset($this->config_fundo_menu)) 
      {
          $_SESSION['config_fundo_menu'] = $this->config_fundo_menu;
      }
      if (isset($_POST["config_cor"]) && isset($this->config_cor)) 
      {
          $_SESSION['config_cor'] = $this->config_cor;
      }
      if (isset($_POST["config_smtp_server"]) && isset($this->config_smtp_server)) 
      {
          $_SESSION['config_smtp_server'] = $this->config_smtp_server;
      }
      if (isset($_POST["config_smtp_user"]) && isset($this->config_smtp_user)) 
      {
          $_SESSION['config_smtp_user'] = $this->config_smtp_user;
      }
      if (isset($_POST["config_smpt_pass"]) && isset($this->config_smpt_pass)) 
      {
          $_SESSION['config_smpt_pass'] = $this->config_smpt_pass;
      }
      ...
      if (isset($_GET["usr_dtpsw"]) && isset($this->usr_dtpsw)) 
      {
          $_SESSION['usr_dtpsw'] = $this->usr_dtpsw;
      }
      if (isset($_GET["usr_expsw"]) && isset($this->usr_expsw)) 
      {
          $_SESSION['usr_expsw'] = $this->usr_expsw;
      }
      if (isset($_GET["config_logo_login"]) && isset($this->config_logo_login)) 
      {
          $_SESSION['config_logo_login'] = $this->config_logo_login;
      }
      if (isset($_GET["config_logo_menu"]) && isset($this->config_logo_menu)) 
      {
          $_SESSION['config_logo_menu'] = $this->config_logo_menu;
      }
      if (isset($_GET["config_fundo_login"]) && isset($this->config_fundo_login)) 
      {
          $_SESSION['config_fundo_login'] = $this->config_fundo_login;
      }
      if (isset($_GET["config_fundo_menu"]) && isset($this->config_fundo_menu)) 
      {
          $_SESSION['config_fundo_menu'] = $this->config_fundo_menu;
      }
      if (isset($_GET["config_cor"]) && isset($this->config_cor)) 
      {
          $_SESSION['config_cor'] = $this->config_cor;
      }
      if (isset($_GET["config_smtp_server"]) && isset($this->config_smtp_server)) 
      {
          $_SESSION['config_smtp_server'] = $this->config_smtp_server;
      }
      if (isset($_GET["config_smtp_user"]) && isset($this->config_smtp_user)) 
      {
          $_SESSION['config_smtp_user'] = $this->config_smtp_user;
      }
      if (isset($_GET["config_smpt_pass"]) && isset($this->config_smpt_pass)) 
      {
          $_SESSION['config_smpt_pass'] = $this->config_smpt_pass;
      }
      ...
      { 
          ...
          if (isset($this->usr_dtpsw)) 
          {
              $_SESSION['usr_dtpsw'] = $this->usr_dtpsw;
          }
          if (isset($this->usr_expsw)) 
          {
              $_SESSION['usr_expsw'] = $this->usr_expsw;
          }
          if (isset($this->config_logo_login)) 
          {
              $_SESSION['config_logo_login'] = $this->config_logo_login;
          }
          if (isset($this->config_logo_menu)) 
          {
              $_SESSION['config_logo_menu'] = $this->config_logo_menu;
          }
          if (isset($this->config_fundo_login)) 
          {
              $_SESSION['config_fundo_login'] = $this->config_fundo_login;
          }
          if (isset($this->config_fundo_menu)) 
          {
              $_SESSION['config_fundo_menu'] = $this->config_fundo_menu;
          }
          if (isset($this->config_cor)) 
          {
              $_SESSION['config_cor'] = $this->config_cor;
          }
          if (isset($this->config_smtp_server)) 
          {
              $_SESSION['config_smtp_server'] = $this->config_smtp_server;
          }
          if (isset($this->config_smtp_user)) 
          {
              $_SESSION['config_smtp_user'] = $this->config_smtp_user;
          }
          if (isset($this->config_smpt_pass)) 
          {
              $_SESSION['config_smpt_pass'] = $this->config_smpt_pass;
          }
...
if (isset($_GET['lang']) && !empty($_GET['lang'])) {
	 ...
	 switch($_GET['lang'])
	 {
        ...
        case 'es':
            ...
            break;
		case 'fr':
            $this->Ini->sc_change_language('fr');
            $this->Ini->sc_change_regional('fr_fr');
            break;
		case 'us':
...
$_SESSION['scriptcase']['sec_Login']['contr_erro'] = 'off';
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_Login']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_Login']['label'] = "GO iTanks";
...
//
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          if ($Campos_Crit == "" && empty($Campos_Falta) && $this->Campos_Mens_erro == "" && !isset($this->bok) && $this->nmgp_opcao != "recarga")
          {
              ...
              { 
                  ...
                  $remember_me = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][3]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][3] = $this->remember_me; 
          if (!empty($this->links))
          {
...
<HEAD>
 <TITLE><?php echo strip_tags("GO iTanks") ?></TITLE>
...
if (!isset($this->sc_temp_config_smpt_pass)) {$this->sc_temp_config_smpt_pass = (isset($_SESSION['config_smpt_pass'])) ? $_SESSION['config_smpt_pass'] : "";}
if (!isset($this->sc_temp_config_smtp_user)) {$this->sc_temp_config_smtp_user = (isset($_SESSION['config_smtp_user'])) ? $_SESSION['config_smtp_user'] : "";}
if (!isset($this->sc_temp_config_smtp_server)) {$this->sc_temp_config_smtp_server = (isset($_SESSION['config_smtp_server'])) ? $_SESSION['config_smtp_server'] : "";}
if (!isset($this->sc_temp_config_cor)) {$this->sc_temp_config_cor = (isset($_SESSION['config_cor'])) ? $_SESSION['config_cor'] : "";}
if (!isset($this->sc_temp_config_fundo_menu)) {$this->sc_temp_config_fundo_menu = (isset($_SESSION['config_fundo_menu'])) ? $_SESSION['config_fundo_menu'] : "";}
if (!isset($this->sc_temp_config_fundo_login)) {$this->sc_temp_config_fundo_login = (isset($_SESSION['config_fundo_login'])) ? $_SESSION['config_fundo_login'] : "";}
if (!isset($this->sc_temp_config_logo_menu)) {$this->sc_temp_config_logo_menu = (isset($_SESSION['config_logo_menu'])) ? $_SESSION['config_logo_menu'] : "";}
if (!isset($this->sc_temp_config_logo_login)) {$this->sc_temp_config_logo_login = (isset($_SESSION['config_logo_login'])) ? $_SESSION['config_logo_login'] : "";}
if (!isset($this->sc_temp_usr_expsw)) {$this->sc_temp_usr_expsw = (isset($_SESSION['usr_expsw'])) ? $_SESSION['usr_expsw'] : "";}
if (!isset($this->sc_temp_usr_dtpsw)) {$this->sc_temp_usr_dtpsw = (isset($_SESSION['usr_dtpsw'])) ? $_SESSION['usr_dtpsw'] : "";}
if (!isset($this->sc_temp_usr_email)) {$this->sc_temp_usr_email = (isset($_SESSION['usr_email'])) ? $_SESSION['usr_email'] : "";}
  ...
  if($this->sc_logged_is_blocked()) { if (isset($this->Campos_Mens_erro) && !empty($this->Campos_Mens_erro))
{
 ...
 if (isset($this->sc_temp_usr_email)) { $_SESSION['usr_email'] = $this->sc_temp_usr_email;}
 if (isset($this->sc_temp_usr_dtpsw)) { $_SESSION['usr_dtpsw'] = $this->sc_temp_usr_dtpsw;}
 if (isset($this->sc_temp_usr_expsw)) { $_SESSION['usr_expsw'] = $this->sc_temp_usr_expsw;}
 if (isset($this->sc_temp_config_logo_login)) { $_SESSION['config_logo_login'] = $this->sc_temp_config_logo_login;}
 if (isset($this->sc_temp_config_logo_menu)) { $_SESSION['config_logo_menu'] = $this->sc_temp_config_logo_menu;}
 if (isset($this->sc_temp_config_fundo_login)) { $_SESSION['config_fundo_login'] = $this->sc_temp_config_fundo_login;}
 if (isset($this->sc_temp_config_fundo_menu)) { $_SESSION['config_fundo_menu'] = $this->sc_temp_config_fundo_menu;}
 if (isset($this->sc_temp_config_cor)) { $_SESSION['config_cor'] = $this->sc_temp_config_cor;}
 if (isset($this->sc_temp_config_smtp_server)) { $_SESSION['config_smtp_server'] = $this->sc_temp_config_smtp_server;}
 if (isset($this->sc_temp_config_smtp_user)) { $_SESSION['config_smtp_user'] = $this->sc_temp_config_smtp_user;}
 if (isset($this->sc_temp_config_smpt_pass)) { $_SESSION['config_smpt_pass'] = $this->sc_temp_config_smpt_pass;}
    $_SESSION['scriptcase']['sec_Login']['contr_erro'] = 'off';
    return;
}
}
   ...
   config 
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                      $this->rsconfig[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->rsconfig = false;
          $this->rsconfig_erro = $this->Db->ErrorMsg();
      } 
...
else if($this->rs[0][1] == 'Y')
{
	...
	$this->sc_temp_usr_dtpsw		= $this->rs[0][4];
	$this->sc_temp_usr_expsw		= $this->rs[0][5];
	
	$this->sc_temp_config_logo_login		= $this->rsconfig[0][1];
	$this->sc_temp_config_logo_menu		= $this->rsconfig[0][2];
	$this->sc_temp_config_fundo_login	= $this->rsconfig[0][3];
	$this->sc_temp_config_fundo_menu		= $this->rsconfig[0][4];
	$this->sc_temp_config_cor	    	= $this->rsconfig[0][5];
	$this->sc_temp_config_smtp_server	= $this->rsconfig[0][6];
	$this->sc_temp_config_smtp_user		= $this->rsconfig[0][7];
	$this->sc_temp_config_smpt_pass		= $this->rsconfig[0][8];
...
$aLookup[] = array(sec_Login_pack_protect_string('1') => str_replace('<', '&lt;',sec_Login_pack_protect_string("Manter Conectado")));
...
;
	...
	if($this->sc_logged($this->login )):
        ...
        if (is_file($_SESSION['scriptcase']['dir_temp'] . "/sc_apl_default_showrural.txt")) {
    unlink($_SESSION['scriptcase']['dir_temp'] . "/sc_apl_default_showrural.txt");
}
if (is_file("../_lib/_app_data/sec_Login_ini.php")) {
    $SC_arq_def = fopen($_SESSION['scriptcase']['dir_temp'] . "/sc_apl_default_showrural.txt", "w");
    fwrite ($SC_arq_def, 'sec_Login, R');
    fclose ($SC_arq_def);
    setcookie('sc_apl_default_showrural','sec_Login, R','0','/');
}
;
		 if (isset($this->sc_temp_usr_login)) { $_SESSION['usr_login'] = $this->sc_temp_usr_login;}
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
...
$_SESSION['scriptcase']['sec_Login']['contr_erro'] = 'on';
		...
		$str_sql = "SELECT date_login, ip FROM public.sec_logged WHERE login = ". $this->Db->qstr($user) ." AND sc_session <> ".$this->Db->qstr('_SC_FAIL_SC_');
...
if (!isset($this->sc_temp_logged_user)) {$this->sc_temp_logged_user = (isset($_SESSION['logged_user'])) ? $_SESSION['logged_user'] : "";}
		...
		$str_sql = "SELECT count(*) FROM public.sec_logged WHERE login = ". $this->Db->qstr($this->sc_temp_logged_user) . " AND date_login = ". $this->Db->qstr($this->sc_temp_logged_date_login) ." AND sc_session <> ".$this->Db->qstr('_SC_FAIL_SC_');
...
if (!isset($this->sc_temp_logged_user)) {$this->sc_temp_logged_user = (isset($_SESSION['logged_user'])) ? $_SESSION['logged_user'] : "";}
    ...
    $this->sc_temp_logged_date_login = microtime(true);
        ...
        $str_sql = "DELETE FROM public.sec_logged WHERE login = ". $this->Db->qstr($user) . " AND sc_session = ".$this->Db->qstr('_SC_FAIL_SC_')." AND ip = ".$this->Db->qstr($ip);
     ...
     $nm_select = $str_sql; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
    	...
    	$str_sql = "INSERT INTO public.sec_logged(login, date_login, sc_session, ip) VALUES (". $this->Db->qstr($user) .", ". $this->Db->qstr($this->sc_temp_logged_date_login) .", ". $this->Db->qstr(session_id()) .", ". $this->Db->qstr($ip) .")";
...
$_SESSION['scriptcase']['sec_Login']['contr_erro'] = 'on';
    ...
    $user = $this->Db->qstr($user);
        $str_sql = "INSERT INTO public.sec_logged(login, date_login, sc_session, ip) VALUES (" . $this->Db->qstr($user) . ", " . $this->Db->qstr(microtime(true)) . ", ". $this->Db->qstr('_SC_FAIL_SC_').", " . $this->Db->qstr($ip) . ")";
...
if (!isset($this->sc_temp_sett_brute_force_time_block)) {$this->sc_temp_sett_brute_force_time_block = (isset($_SESSION['sett_brute_force_time_block'])) ? $_SESSION['sett_brute_force_time_block'] : "";}
    ...
    $str_select = "SELECT count(*) FROM public.sec_logged WHERE sc_session = ".$this->Db->qstr('_SC_BLOCKED_SC_')." AND ip = ".$this->Db->qstr($ip)." AND date_login > ". $this->Db->qstr($minutes_ago);
...
;
        ...
        $str_select = "SELECT count(*) FROM public.sec_logged WHERE sc_session = ".$this->Db->qstr('_SC_FAIL_SC_')." AND ip = ".$this->Db->qstr($ip)." AND date_login > ". $this->Db->qstr($minutes_ago);
      ...
      { 
        ...
        {
            $str_sql = "INSERT INTO public.sec_logged(login, date_login, sc_session, ip) VALUES (".$this->Db->qstr('blocked').", ". $this->Db->qstr(microtime(true)) .", ".$this->Db->qstr('_SC_BLOCKED_SC_'). ", ". $this->Db->qstr($ip) .")";
...
if (!isset($this->sc_temp_logged_date_login)) {$this->sc_temp_logged_date_login = (isset($_SESSION['logged_date_login'])) ? $_SESSION['logged_date_login'] : "";}
		...
		$str_sql = "SELECT sc_session FROM public.sec_logged WHERE login = ". $this->Db->qstr($user) ." ". $date_login . " AND sc_session <> ".$this->Db->qstr('_SC_FAIL_SC_');
    ...
    if(isset($this->data[0][0]) && !empty($this->data[0][0]))
		...
		$str_sql = "DELETE FROM public.sec_logged WHERE login = ". $this->Db->qstr($user) . " " . $date_login;
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "Manter Conectado?#?1?#?N?@?";
