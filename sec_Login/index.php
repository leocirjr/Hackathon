...
//
   ...
   $_SESSION['scriptcase']['sec_Login']['glo_nm_perfil']          = "conn_postgres";
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['sec_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'showrural', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['sec_Login']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['sec_Login']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['sec_Login']['glo_nm_conexao'], $this->root . $this->path_prod, 'showrural', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        elseif (is_file($root . $_SESSION['scriptcase']['sec_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_showrural.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['sec_Login']['glo_nm_path_imag_temp'] . "/sc_apl_default_showrural.txt"));
        }
        if (isset($apl_def)) {
            ...
            if (isset($_COOKIE['sc_actual_lang_showrural'])) {
                $_SESSION['scriptcase']['sec_Login']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_showrural'];
            }
        }
    }
    ...
    { 
        ...
        if (isset($usr_dtpsw)) 
        {
            $_SESSION['usr_dtpsw'] = $usr_dtpsw;
        }
        if (isset($usr_expsw)) 
        {
            $_SESSION['usr_expsw'] = $usr_expsw;
        }
        if (isset($config_logo_login)) 
        {
            $_SESSION['config_logo_login'] = $config_logo_login;
        }
        if (isset($config_logo_menu)) 
        {
            $_SESSION['config_logo_menu'] = $config_logo_menu;
        }
        if (isset($config_fundo_login)) 
        {
            $_SESSION['config_fundo_login'] = $config_fundo_login;
        }
        if (isset($config_fundo_menu)) 
        {
            $_SESSION['config_fundo_menu'] = $config_fundo_menu;
        }
        if (isset($config_cor)) 
        {
            $_SESSION['config_cor'] = $config_cor;
        }
        if (isset($config_smtp_server)) 
        {
            $_SESSION['config_smtp_server'] = $config_smtp_server;
        }
        if (isset($config_smtp_user)) 
        {
            $_SESSION['config_smtp_user'] = $config_smtp_user;
        }
        if (isset($config_smpt_pass)) 
        {
            $_SESSION['config_smpt_pass'] = $config_smpt_pass;
        }
    ...
    else
    {
        ...
        if (isset($_POST["usr_dtpsw"])) 
        {
            $_SESSION['usr_dtpsw'] = $_POST["usr_dtpsw"];
            nm_limpa_str_sec_Login($_SESSION['usr_dtpsw']);
        }
        if (isset($_GET["usr_dtpsw"])) 
        {
            $_SESSION['usr_dtpsw'] = $_GET["usr_dtpsw"];
            nm_limpa_str_sec_Login($_SESSION['usr_dtpsw']);
        }
        if (isset($_POST["usr_expsw"])) 
        {
            $_SESSION['usr_expsw'] = $_POST["usr_expsw"];
            nm_limpa_str_sec_Login($_SESSION['usr_expsw']);
        }
        if (isset($_GET["usr_expsw"])) 
        {
            $_SESSION['usr_expsw'] = $_GET["usr_expsw"];
            nm_limpa_str_sec_Login($_SESSION['usr_expsw']);
        }
        if (isset($_POST["config_logo_login"])) 
        {
            $_SESSION['config_logo_login'] = $_POST["config_logo_login"];
            nm_limpa_str_sec_Login($_SESSION['config_logo_login']);
        }
        if (isset($_GET["config_logo_login"])) 
        {
            $_SESSION['config_logo_login'] = $_GET["config_logo_login"];
            nm_limpa_str_sec_Login($_SESSION['config_logo_login']);
        }
        if (isset($_POST["config_logo_menu"])) 
        {
            $_SESSION['config_logo_menu'] = $_POST["config_logo_menu"];
            nm_limpa_str_sec_Login($_SESSION['config_logo_menu']);
        }
        if (isset($_GET["config_logo_menu"])) 
        {
            $_SESSION['config_logo_menu'] = $_GET["config_logo_menu"];
            nm_limpa_str_sec_Login($_SESSION['config_logo_menu']);
        }
        if (isset($_POST["config_fundo_login"])) 
        {
            $_SESSION['config_fundo_login'] = $_POST["config_fundo_login"];
            nm_limpa_str_sec_Login($_SESSION['config_fundo_login']);
        }
        if (isset($_GET["config_fundo_login"])) 
        {
            $_SESSION['config_fundo_login'] = $_GET["config_fundo_login"];
            nm_limpa_str_sec_Login($_SESSION['config_fundo_login']);
        }
        if (isset($_POST["config_fundo_menu"])) 
        {
            $_SESSION['config_fundo_menu'] = $_POST["config_fundo_menu"];
            nm_limpa_str_sec_Login($_SESSION['config_fundo_menu']);
        }
        if (isset($_GET["config_fundo_menu"])) 
        {
            $_SESSION['config_fundo_menu'] = $_GET["config_fundo_menu"];
            nm_limpa_str_sec_Login($_SESSION['config_fundo_menu']);
        }
        if (isset($_POST["config_cor"])) 
        {
            $_SESSION['config_cor'] = $_POST["config_cor"];
            nm_limpa_str_sec_Login($_SESSION['config_cor']);
        }
        if (isset($_GET["config_cor"])) 
        {
            $_SESSION['config_cor'] = $_GET["config_cor"];
            nm_limpa_str_sec_Login($_SESSION['config_cor']);
        }
        if (isset($_POST["config_smtp_server"])) 
        {
            $_SESSION['config_smtp_server'] = $_POST["config_smtp_server"];
            nm_limpa_str_sec_Login($_SESSION['config_smtp_server']);
        }
        if (isset($_GET["config_smtp_server"])) 
        {
            $_SESSION['config_smtp_server'] = $_GET["config_smtp_server"];
            nm_limpa_str_sec_Login($_SESSION['config_smtp_server']);
        }
        if (isset($_POST["config_smtp_user"])) 
        {
            $_SESSION['config_smtp_user'] = $_POST["config_smtp_user"];
            nm_limpa_str_sec_Login($_SESSION['config_smtp_user']);
        }
        if (isset($_GET["config_smtp_user"])) 
        {
            $_SESSION['config_smtp_user'] = $_GET["config_smtp_user"];
            nm_limpa_str_sec_Login($_SESSION['config_smtp_user']);
        }
        if (isset($_POST["config_smpt_pass"])) 
        {
            $_SESSION['config_smpt_pass'] = $_POST["config_smpt_pass"];
            nm_limpa_str_sec_Login($_SESSION['config_smpt_pass']);
        }
        if (isset($_GET["config_smpt_pass"])) 
        {
            $_SESSION['config_smpt_pass'] = $_GET["config_smpt_pass"];
            nm_limpa_str_sec_Login($_SESSION['config_smpt_pass']);
        }
...
//
    ...
    function ajax_sec_Login_submit_form($login, $pswd, $links, $remember_me, $links_sc_target_name, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token, $bok)
    {
        global $inicial_sec_Login;
        //register_shutdown_function("sec_Login_pack_ajax_response");
        $inicial_sec_Login->contr_sec_Login->NM_ajax_flag          = true;
