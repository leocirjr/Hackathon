...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "insert_data";$Nm_datas[] = "update_data";$Nm_numeric[] = "id_pessoa";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_pessoa_cond" name="id_pessoa_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_pessoa'), this, 'id_pessoa')">
      ...
      <br><span id="id_hide_id_pessoa"  <?php echo $str_hide_id_pessoa?>><INPUT  type="text" id="SC_id_pessoa" name="id_pessoa" value="<?php echo NM_encode_input($id_pessoa) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nome_pessoa_cond" name="nome_pessoa_cond" onChange="nm_campos_between(document.getElementById('id_vis_nome_pessoa'), this, 'nome_pessoa')">
      ...
      <br><span id="id_hide_nome_pessoa"  <?php echo $str_hide_nome_pessoa?>><?php
      if ($nome_pessoa != "")
      {
      $nome_pessoa_look = (is_string($nome_pessoa) ? substr($this->Db->qstr($nome_pessoa), 1, -1) : $nome_pessoa); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_razao_social_cond" name="razao_social_cond" onChange="nm_campos_between(document.getElementById('id_vis_razao_social'), this, 'razao_social')">
      ...
      <br><span id="id_hide_razao_social"  <?php echo $str_hide_razao_social?>><?php
      if ($razao_social != "")
      {
      $razao_social_look = (is_string($razao_social) ? substr($this->Db->qstr($razao_social), 1, -1) : $razao_social); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_tipo_pessoa_cond" name="tipo_pessoa_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipo_pessoa'), this, 'tipo_pessoa')">
      ...
      <br><span id="id_hide_tipo_pessoa"  <?php echo $str_hide_tipo_pessoa?>><?php
      if ($tipo_pessoa != "")
      {
      $tipo_pessoa_look = (is_string($tipo_pessoa) ? substr($this->Db->qstr($tipo_pessoa), 1, -1) : $tipo_pessoa); 
      $nmgp_def_dados = array(); 
