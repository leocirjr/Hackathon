...
class grid_transportadora_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_transportadora_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_transportadora_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_transportadora_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nome_pessoa')
      {
          $nome_pessoa = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nome_pessoa($nome_pessoa);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_razao_social')
      {
          $razao_social = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_razao_social($razao_social);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_tipo_pessoa')
      {
          $tipo_pessoa = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_tipo_pessoa($tipo_pessoa);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "insert_data";$Nm_datas[] = "update_data";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "public.view_produtor.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome_sum . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $this->comando_filtro .= $nm_ini_lower . $Nm_accent['cmp_i'] . $nome . $Nm_accent['cmp_f'] . $nm_fim_lower . $Nm_accent['cmp_apos'] . $op_all . $nm_ini_lower . "'%" . $Nm_accent['arg_i'] . $campo . $Nm_accent['arg_f'] . "%'" . $nm_fim_lower . $Nm_accent['arg_apos'];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<?php
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['orig_pesq'] == "res")  
    { 
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_transportadora/grid_transportadora_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<?php echo $this->Ini->Ajax_result_set ?>
 ...
 <script type="text/javascript" src="grid_transportadora_ajax_search.js"></script>
 <script type="text/javascript" src="grid_transportadora_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_transportadora_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_transportadora']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_transportadora']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_pessoa_cond#NMF#' + search_get_sel_txt('SC_id_pessoa_cond') + '@NMF@';
  str_out += 'SC_id_pessoa#NMF#' + search_get_text('SC_id_pessoa') + '@NMF@';
  str_out += 'SC_nome_pessoa_cond#NMF#' + search_get_sel_txt('SC_nome_pessoa_cond') + '@NMF@';
  str_out += 'SC_nome_pessoa#NMF#' + search_get_text('SC_nome_pessoa') + '@NMF@';
  str_out += 'id_ac_nome_pessoa#NMF#' + search_get_text('id_ac_nome_pessoa') + '@NMF@';
  str_out += 'SC_razao_social_cond#NMF#' + search_get_sel_txt('SC_razao_social_cond') + '@NMF@';
  str_out += 'SC_razao_social#NMF#' + search_get_text('SC_razao_social') + '@NMF@';
  str_out += 'id_ac_razao_social#NMF#' + search_get_text('id_ac_razao_social') + '@NMF@';
  str_out += 'SC_tipo_pessoa_cond#NMF#' + search_get_sel_txt('SC_tipo_pessoa_cond') + '@NMF@';
  str_out += 'SC_tipo_pessoa#NMF#' + search_get_text('SC_tipo_pessoa') + '@NMF@';
  str_out += 'id_ac_tipo_pessoa#NMF#' + search_get_text('id_ac_tipo_pessoa') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_nome_pessoa").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nome_pessoa").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nome_pessoa",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_nome_pessoa").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nome_pessoa").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_razao_social").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_razao_social").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_razao_social",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_razao_social").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_razao_social").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_tipo_pessoa").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_tipo_pessoa").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_tipo_pessoa",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_tipo_pessoa").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($this->Ini->Embutida_iframe || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Transportadora</div>
...
<?php
   ...
   {
      global 
             $id_pessoa_cond, $id_pessoa,
             $nome_pessoa_cond, $nome_pessoa, $nome_pessoa_autocomp,
             $razao_social_cond, $razao_social, $razao_social_autocomp,
             $tipo_pessoa_cond, $tipo_pessoa, $tipo_pessoa_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $id_pessoa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['id_pessoa']; 
          $id_pessoa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['id_pessoa_cond']; 
          $nome_pessoa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['nome_pessoa']; 
          $nome_pessoa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['nome_pessoa_cond']; 
          $razao_social = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['razao_social']; 
          $razao_social_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['razao_social_cond']; 
          $tipo_pessoa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['tipo_pessoa']; 
          $tipo_pessoa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['tipo_pessoa_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['NM_operador']; 
          if (strtoupper($id_pessoa_cond) != "II" && strtoupper($id_pessoa_cond) != "QP" && strtoupper($id_pessoa_cond) != "NP" && strtoupper($id_pessoa_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_pessoa, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($id_pessoa_cond) || empty($id_pessoa_cond))
      {
         $id_pessoa_cond = "gt";
      }
      if (!isset($nome_pessoa_cond) || empty($nome_pessoa_cond))
      {
         $nome_pessoa_cond = "qp";
      }
      if (!isset($razao_social_cond) || empty($razao_social_cond))
      {
         $razao_social_cond = "qp";
      }
      if (!isset($tipo_pessoa_cond) || empty($tipo_pessoa_cond))
      {
         $tipo_pessoa_cond = "qp";
      }
      ...
      $str_hide_id_pessoa = (in_array($id_pessoa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nome_pessoa = (in_array($nome_pessoa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_razao_social = (in_array($razao_social_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_tipo_pessoa = (in_array($tipo_pessoa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($id_pessoa) || $id_pessoa == "")
      {
          $id_pessoa = "";
      }
      if (isset($id_pessoa) && !empty($id_pessoa))
      {
         $tmp_pos = (is_string($id_pessoa)) ? strpos($id_pessoa, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $id_pessoa = substr($id_pessoa, 0, $tmp_pos);
         }
      }
      if (!isset($nome_pessoa) || $nome_pessoa == "")
      {
          $nome_pessoa = "";
      }
      if (isset($nome_pessoa) && !empty($nome_pessoa))
      {
         $tmp_pos = (is_string($nome_pessoa)) ? strpos($nome_pessoa, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $nome_pessoa = substr($nome_pessoa, 0, $tmp_pos);
         }
      }
      if (!isset($razao_social) || $razao_social == "")
      {
          $razao_social = "";
      }
      if (isset($razao_social) && !empty($razao_social))
      {
         $tmp_pos = (is_string($razao_social)) ? strpos($razao_social, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $razao_social = substr($razao_social, 0, $tmp_pos);
         }
      }
      if (!isset($tipo_pessoa) || $tipo_pessoa == "")
      {
          $tipo_pessoa = "";
      }
      if (isset($tipo_pessoa) && !empty($tipo_pessoa))
      {
         $tmp_pos = (is_string($tipo_pessoa)) ? strpos($tipo_pessoa, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $tipo_pessoa = substr($tipo_pessoa, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_id_pessoa_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_pessoa'])) ? $this->New_label['id_pessoa'] : "#"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_pessoa_cond" name="id_pessoa_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_pessoa'), this, 'id_pessoa')">
       <OPTION value="gt" <?php if ("gt" == $id_pessoa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_pessoa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_pessoa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_pessoa" <?php echo $str_hide_id_pessoa?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['id_pessoa'])) ? $this->New_label['id_pessoa'] : "#";
 $nmgp_tab_label .= "id_pessoa?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_id_pessoa" name="id_pessoa" value="<?php echo NM_encode_input($id_pessoa) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_nome_pessoa_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nome_pessoa'])) ? $this->New_label['nome_pessoa'] : "Nome"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nome_pessoa_cond" name="nome_pessoa_cond" onChange="nm_campos_between(document.getElementById('id_vis_nome_pessoa'), this, 'nome_pessoa')">
       <OPTION value="qp" <?php if ("qp" == $nome_pessoa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nome_pessoa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nome_pessoa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nome_pessoa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nome_pessoa" <?php echo $str_hide_nome_pessoa?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nome_pessoa'])) ? $this->New_label['nome_pessoa'] : "Nome";
 $nmgp_tab_label .= "nome_pessoa?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $nome_pessoa;
      }
?>
<INPUT  type="text" id="SC_nome_pessoa" name="nome_pessoa" value="<?php echo NM_encode_input($nome_pessoa) ?>"  size=50 alt="{datatype: 'text', maxLength: 80, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nome_pessoa" name="nome_pessoa_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 80, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_razao_social_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['razao_social'])) ? $this->New_label['razao_social'] : "Razão Social"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_razao_social_cond" name="razao_social_cond" onChange="nm_campos_between(document.getElementById('id_vis_razao_social'), this, 'razao_social')">
       <OPTION value="qp" <?php if ("qp" == $razao_social_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $razao_social_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $razao_social_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $razao_social_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_razao_social" <?php echo $str_hide_razao_social?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['razao_social'])) ? $this->New_label['razao_social'] : "Razão Social";
 $nmgp_tab_label .= "razao_social?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $razao_social;
      }
?>
<INPUT  type="text" id="SC_razao_social" name="razao_social" value="<?php echo NM_encode_input($razao_social) ?>"  size=50 alt="{datatype: 'text', maxLength: 80, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_razao_social" name="razao_social_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 80, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_tipo_pessoa_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['tipo_pessoa'])) ? $this->New_label['tipo_pessoa'] : "Tipo Pessoa"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_tipo_pessoa_cond" name="tipo_pessoa_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipo_pessoa'), this, 'tipo_pessoa')">
       <OPTION value="qp" <?php if ("qp" == $tipo_pessoa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $tipo_pessoa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $tipo_pessoa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $tipo_pessoa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tipo_pessoa" <?php echo $str_hide_tipo_pessoa?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['tipo_pessoa'])) ? $this->New_label['tipo_pessoa'] : "Tipo Pessoa";
 $nmgp_tab_label .= "tipo_pessoa?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $tipo_pessoa;
      }
?>
<INPUT  type="text" id="SC_tipo_pessoa" name="tipo_pessoa" value="<?php echo NM_encode_input($tipo_pessoa) ?>"  size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tipo_pessoa" name="tipo_pessoa_autocomp" size="1"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_transportadora_help.txt"))
   {
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_pessoa_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_pessoa'), document.F1.id_pessoa_cond, 'id_pessoa');
   document.F1.id_pessoa.value = "";
   document.F1.nome_pessoa_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nome_pessoa'), document.F1.nome_pessoa_cond, 'nome_pessoa');
   document.F1.nome_pessoa.value = "";
   document.F1.nome_pessoa_autocomp.value = "";
   document.F1.razao_social_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_razao_social'), document.F1.razao_social_cond, 'razao_social');
   document.F1.razao_social.value = "";
   document.F1.razao_social_autocomp.value = "";
   document.F1.tipo_pessoa_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_tipo_pessoa'), document.F1.tipo_pessoa_cond, 'tipo_pessoa');
   document.F1.tipo_pessoa.value = "";
   document.F1.tipo_pessoa_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_id_pessoa_cond'] = 'cond';
      $tp_fields['SC_id_pessoa'] = 'text';
      $tp_fields['SC_nome_pessoa_cond'] = 'cond';
      $tp_fields['SC_nome_pessoa'] = 'text_aut';
      $tp_fields['id_ac_nome_pessoa'] = 'text_aut';
      $tp_fields['SC_razao_social_cond'] = 'cond';
      $tp_fields['SC_razao_social'] = 'text_aut';
      $tp_fields['id_ac_razao_social'] = 'text_aut';
      $tp_fields['SC_tipo_pessoa_cond'] = 'cond';
      $tp_fields['SC_tipo_pessoa'] = 'text_aut';
      $tp_fields['id_ac_tipo_pessoa'] = 'text_aut';
   ...
   {
      global $id_pessoa_cond, $id_pessoa,
             $nome_pessoa_cond, $nome_pessoa, $nome_pessoa_autocomp,
             $razao_social_cond, $razao_social, $razao_social_autocomp,
             $tipo_pessoa_cond, $tipo_pessoa, $tipo_pessoa_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($nome_pessoa_autocomp) && empty($nome_pessoa))
      {
          $nome_pessoa = $nome_pessoa_autocomp;
      }
      if (!empty($razao_social_autocomp) && empty($razao_social))
      {
          $razao_social = $razao_social_autocomp;
      }
      if (!empty($tipo_pessoa_autocomp) && empty($tipo_pessoa))
      {
          $tipo_pessoa = $tipo_pessoa_autocomp;
      }
      $id_pessoa_cond_salva = $id_pessoa_cond; 
      if (!isset($id_pessoa_input_2) || $id_pessoa_input_2 == "")
      {
          $id_pessoa_input_2 = $id_pessoa;
      }
      $nome_pessoa_cond_salva = $nome_pessoa_cond; 
      if (!isset($nome_pessoa_input_2) || $nome_pessoa_input_2 == "")
      {
          $nome_pessoa_input_2 = $nome_pessoa;
      }
      $razao_social_cond_salva = $razao_social_cond; 
      if (!isset($razao_social_input_2) || $razao_social_input_2 == "")
      {
          $razao_social_input_2 = $razao_social;
      }
      $tipo_pessoa_cond_salva = $tipo_pessoa_cond; 
      if (!isset($tipo_pessoa_input_2) || $tipo_pessoa_input_2 == "")
      {
          $tipo_pessoa_input_2 = $tipo_pessoa;
      }
      if ($id_pessoa_cond != "in")
      {
          nm_limpa_numero($id_pessoa, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['id_pessoa'] = $id_pessoa; 
      if (is_array($id_pessoa) && !empty($id_pessoa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['val'][0] = $id_pessoa;
      }
      elseif ($id_pessoa_cond_salva == "nu" || $id_pessoa_cond_salva == "nn" || $id_pessoa_cond_salva == "ep" || $id_pessoa_cond_salva == "ne" || !empty($id_pessoa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['val'][0][0] = $id_pessoa;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['id_pessoa_cond'] = $id_pessoa_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['cmp'] = "id_pessoa"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['opc'] = $id_pessoa_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq']['id_pessoa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['nome_pessoa'] = $nome_pessoa; 
      if (is_array($nome_pessoa) && !empty($nome_pessoa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['val'][0] = $nome_pessoa;
      }
      elseif ($nome_pessoa_cond_salva == "nu" || $nome_pessoa_cond_salva == "nn" || $nome_pessoa_cond_salva == "ep" || $nome_pessoa_cond_salva == "ne" || !empty($nome_pessoa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['val'][0][0] = $nome_pessoa;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['nome_pessoa_cond'] = $nome_pessoa_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['cmp'] = "nome_pessoa"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['opc'] = $nome_pessoa_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq']['nome_pessoa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['razao_social'] = $razao_social; 
      if (is_array($razao_social) && !empty($razao_social))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['val'][0] = $razao_social;
      }
      elseif ($razao_social_cond_salva == "nu" || $razao_social_cond_salva == "nn" || $razao_social_cond_salva == "ep" || $razao_social_cond_salva == "ne" || !empty($razao_social))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['val'][0][0] = $razao_social;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['razao_social_cond'] = $razao_social_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['cmp'] = "razao_social"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['opc'] = $razao_social_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq']['razao_social'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['tipo_pessoa'] = $tipo_pessoa; 
      if (is_array($tipo_pessoa) && !empty($tipo_pessoa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['val'][0] = $tipo_pessoa;
      }
      elseif ($tipo_pessoa_cond_salva == "nu" || $tipo_pessoa_cond_salva == "nn" || $tipo_pessoa_cond_salva == "ep" || $tipo_pessoa_cond_salva == "ne" || !empty($tipo_pessoa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['val'][0][0] = $tipo_pessoa;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['tipo_pessoa_cond'] = $tipo_pessoa_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['cmp'] = "tipo_pessoa"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid]['opc'] = $tipo_pessoa_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['grid_pesq']['tipo_pessoa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['id_pessoa'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($nome_pessoa != '') {
      $nome_pessoa_look = (is_string($nome_pessoa) ? substr($this->Db->qstr($nome_pessoa), 1, -1) : $nome_pessoa); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nome_pessoa'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nome_pessoa'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nome_pessoa'] = $nome_pessoa;
      }
      $nmgp_def_dados = array();
    if ($razao_social != '') {
      $razao_social_look = (is_string($razao_social) ? substr($this->Db->qstr($razao_social), 1, -1) : $razao_social); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['razao_social'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['razao_social'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['razao_social'] = $razao_social;
      }
      $nmgp_def_dados = array();
    if ($tipo_pessoa != '') {
      $tipo_pessoa_look = (is_string($tipo_pessoa) ? substr($this->Db->qstr($tipo_pessoa), 1, -1) : $tipo_pessoa); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['tipo_pessoa'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['tipo_pessoa'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['tipo_pessoa'] = $tipo_pessoa;
      }

      //----- $id_pessoa
      $this->Date_part = false;
      if (isset($id_pessoa) || $id_pessoa_cond == "nu" || $id_pessoa_cond == "nn" || $id_pessoa_cond == "ep" || $id_pessoa_cond == "ne")
      {
         $this->monta_condicao("id_pessoa", $id_pessoa_cond, $id_pessoa, "", "id_pessoa", "INT4", false);
      }

      //----- $nome_pessoa
      $this->Date_part = false;
      if (isset($nome_pessoa) || $nome_pessoa_cond == "nu" || $nome_pessoa_cond == "nn" || $nome_pessoa_cond == "ep" || $nome_pessoa_cond == "ne")
      {
         $this->monta_condicao("nome_pessoa", $nome_pessoa_cond, $nome_pessoa, "", "nome_pessoa", "VARCHAR", false);
      }

      //----- $razao_social
      $this->Date_part = false;
      if (isset($razao_social) || $razao_social_cond == "nu" || $razao_social_cond == "nn" || $razao_social_cond == "ep" || $razao_social_cond == "ne")
      {
         $this->monta_condicao("razao_social", $razao_social_cond, $razao_social, "", "razao_social", "VARCHAR", false);
      }

      //----- $tipo_pessoa
      $this->Date_part = false;
      if (isset($tipo_pessoa) || $tipo_pessoa_cond == "nu" || $tipo_pessoa_cond == "nn" || $tipo_pessoa_cond == "ep" || $tipo_pessoa_cond == "ne")
      {
         $this->monta_condicao("tipo_pessoa", $tipo_pessoa_cond, $tipo_pessoa, "", "tipo_pessoa", "BPCHAR", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_pesq_grid']    = $this->comando_filtro;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['cond_pesq'] .= $this->NM_operador;
