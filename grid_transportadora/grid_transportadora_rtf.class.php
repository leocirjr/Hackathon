...
function actionBar_getStateHide($buttonName)
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_transportadora.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['grid_transportadora']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['rtf_name']);
      }
   ...
   function NM_export_id_pessoa()
   {
         ...
         $this->id_pessoa = str_replace('<', '&lt;', $this->id_pessoa);
         $this->id_pessoa = str_replace('>', '&gt;', $this->id_pessoa);
         $this->Texto_tag .= "<td>" . $this->id_pessoa . "</td>\r\n";
   }
   //----- nome_pessoa
   function NM_export_nome_pessoa()
   {
         ...
         $this->nome_pessoa = str_replace('<', '&lt;', $this->nome_pessoa);
         $this->nome_pessoa = str_replace('>', '&gt;', $this->nome_pessoa);
         $this->Texto_tag .= "<td>" . $this->nome_pessoa . "</td>\r\n";
   }
   //----- razao_social
   ...
   function NM_export_tipo_pessoa()
   {
         ...
         $this->tipo_pessoa = str_replace('<', '&lt;', $this->tipo_pessoa);
         $this->tipo_pessoa = str_replace('>', '&gt;', $this->tipo_pessoa);
         $this->Texto_tag .= "<td>" . $this->tipo_pessoa . "</td>\r\n";
   }
   //----- cpf
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_transportadora']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Transportadora :: RTF</TITLE>
