...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["showrural_____grid_transportadora"]))
   {
      unset($_SESSION['session_sec_aplicacao']["showrural_____grid_transportadora"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_pessoa'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_transportadora']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_transportadora']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_transportadora']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_transportadora']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_transportadora']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_transportadora</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_transportadora']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_transportadora']['embutida_filho'] as $ind => $sc_init)
          {
