...
<?php
   ...
   $Ord_Cmp = new grid_transportadora_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_transportadora_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_pessoa'] = "id_pessoa";
   $tab_labels["id_pessoa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_transportadora']['labels']["id_pessoa"])) ? $_SESSION['sc_session'][$sc_init]['grid_transportadora']['labels']["id_pessoa"] : "#";
   $tab_ger_campos['nome_pessoa'] = "on";
   $tab_def_campos['nome_pessoa'] = "nome_pessoa";
   $tab_labels["nome_pessoa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_transportadora']['labels']["nome_pessoa"])) ? $_SESSION['sc_session'][$sc_init]['grid_transportadora']['labels']["nome_pessoa"] : "Nome";
   $tab_ger_campos['razao_social'] = "on";
   $tab_def_campos['razao_social'] = "razao_social";
   $tab_labels["razao_social"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_transportadora']['labels']["razao_social"])) ? $_SESSION['sc_session'][$sc_init]['grid_transportadora']['labels']["razao_social"] : "Razão Social";
   $tab_ger_campos['cnpj'] = "on";
   $tab_def_campos['cnpj'] = "cnpj";
   $tab_labels["cnpj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_transportadora']['labels']["cnpj"])) ? $_SESSION['sc_session'][$sc_init]['grid_transportadora']['labels']["cnpj"] : "CNPJ";
   $tab_ger_campos['uf'] = "on";
   $tab_def_campos['uf'] = "uf";
   $tab_labels["uf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_transportadora']['labels']["uf"])) ? $_SESSION['sc_session'][$sc_init]['grid_transportadora']['labels']["uf"] : "UF";
   $tab_ger_campos['cidade'] = "on";
   $tab_def_campos['cidade'] = "cidade";
   $tab_labels["cidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_transportadora']['labels']["cidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_transportadora']['labels']["cidade"] : "Cidade";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_transportadora']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_transportadora']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_transportadora']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_transportadora_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_transportadora']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
