<?php
@session_start() ;
$_SESSION['scriptcase']['grid_transportadora']['sc_process_barr'] = true;
require_once('../grid_transportadora/index.php');
unset($_SESSION['scriptcase']['grid_transportadora']['sc_process_barr']);
$ExportCtrl = new grid_transportadora_export_control;
$ExportCtrl->Export_barr();

class grid_transportadora_export_control
{
