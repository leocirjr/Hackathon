...
.scFilterPage{margin: 10px 10px 10px 10px !important; Padding: 0px !important; background-image: none !important; background: #eef0f8 !important;}		
.scFilterHeader{background-color: #ffffff!important; border-radius: 10px !important}
.scFilterHeaderFont{Padding: 3px 10px !important; color: #252C36!important; font-size: 15px !important; font-weight: bold !important;}
.scFilterTable{margin: 0px 8px 0px 8px !important; box-shadow: none !important; width: 98% !important;}
.scFilterToolbarPadding{Padding:8px 8px 8px 8px !important;}
.scFilterBlock{padding: 3px !important}
.scFilterLabelOddMult{Padding: 10px 3px !important; background-color: #ffffff !important; border:1px !important; border-style: solid !important; box-shadow: none  !important; border-color: #ffffff #ffffff #e3eaef #ffffff !important}
...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      else
      {
         ...
         $nomeX = $nome;
         $nome = $nomeX;
         $nome_sum = "custos_ferramentas.sec_groups.$nome";
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Gerenciamento de Acessos</span></td>
...
$_SESSION['scriptcase']['sec_search_sec_groups']['contr_erro'] = 'off'; 
      ...
      if (isset($group_id))
      {
         $this->monta_condicao("group_id", $group_id_cond, $group_id, "", "group_id", "INT4", false);
      }
   }
