...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["showrural_____grid_cliente_pedido"]))
   {
      unset($_SESSION['session_sec_aplicacao']["showrural_____grid_cliente_pedido"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_cliente_pedido'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cliente_pedido']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cliente_pedido']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cliente_pedido']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cliente_pedido']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cliente_pedido']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_cliente_pedido</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cliente_pedido']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cliente_pedido']['embutida_filho'] as $ind => $sc_init)
          {
