...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id_cliente_pedido";$Nm_numeric[] = "prazo_dias_envio";$Nm_numeric[] = "quantidade";$Nm_numeric[] = "preco";$Nm_numeric[] = "total";$Nm_numeric[] = "id_cliente_pedido";$Nm_numeric[] = "prazo_dias_envio";$Nm_numeric[] = "quantidade";$Nm_numeric[] = "preco";$Nm_numeric[] = "total";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_id_cliente_pedido_cond" name="id_cliente_pedido_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_cliente_pedido'), this, 'id_cliente_pedido')">
