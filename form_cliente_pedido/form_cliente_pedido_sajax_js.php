  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cliente_pedido" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cliente_pedido_form();
	}
...
?>
  ...
  function do_ajax_form_cliente_pedido_validate_id_cliente_pedido()
  {
    ...
    x_ajax_form_cliente_pedido_validate_id_cliente_pedido(var_id_cliente_pedido, var_script_case_init, do_ajax_form_cliente_pedido_validate_id_cliente_pedido_cb);
  } // do_ajax_form_cliente_pedido_validate_id_cliente_pedido

  function do_ajax_form_cliente_pedido_validate_id_cliente_pedido_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_pedido_validate_id_cliente_pedido_cb

  // ---------- Validate regiao
  function do_ajax_form_cliente_pedido_validate_regiao()
  {
    var nomeCampo_regiao = "regiao";
    var var_regiao = scAjaxGetFieldSelect(nomeCampo_regiao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_pedido_validate_regiao(var_regiao, var_script_case_init, do_ajax_form_cliente_pedido_validate_regiao_cb);
  } // do_ajax_form_cliente_pedido_validate_regiao

  function do_ajax_form_cliente_pedido_validate_regiao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "regiao";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_pedido_validate_regiao_cb

  // ---------- Validate id_produtor
  function do_ajax_form_cliente_pedido_validate_id_produtor()
  {
    var nomeCampo_id_produtor = "id_produtor";
    var var_id_produtor = scAjaxGetFieldSelect(nomeCampo_id_produtor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_pedido_validate_id_produtor(var_id_produtor, var_script_case_init, do_ajax_form_cliente_pedido_validate_id_produtor_cb);
  } // do_ajax_form_cliente_pedido_validate_id_produtor

  function do_ajax_form_cliente_pedido_validate_id_produtor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_pedido_validate_id_produtor_cb

  // ---------- Validate id_produto
  function do_ajax_form_cliente_pedido_validate_id_produto()
  {
    var nomeCampo_id_produto = "id_produto";
    var var_id_produto = scAjaxGetFieldSelect(nomeCampo_id_produto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_pedido_validate_id_produto(var_id_produto, var_script_case_init, do_ajax_form_cliente_pedido_validate_id_produto_cb);
  } // do_ajax_form_cliente_pedido_validate_id_produto

  function do_ajax_form_cliente_pedido_validate_id_produto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_pedido_validate_id_produto_cb

  // ---------- Validate quantidade
  function do_ajax_form_cliente_pedido_validate_quantidade()
  {
    var nomeCampo_quantidade = "quantidade";
    var var_quantidade = scAjaxGetFieldText(nomeCampo_quantidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_pedido_validate_quantidade(var_quantidade, var_script_case_init, do_ajax_form_cliente_pedido_validate_quantidade_cb);
  } // do_ajax_form_cliente_pedido_validate_quantidade

  function do_ajax_form_cliente_pedido_validate_quantidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_pedido_validate_quantidade_cb

  // ---------- Validate valor
  function do_ajax_form_cliente_pedido_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldHidden(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_pedido_validate_valor(var_valor, var_script_case_init, do_ajax_form_cliente_pedido_validate_valor_cb);
  } // do_ajax_form_cliente_pedido_validate_valor

  function do_ajax_form_cliente_pedido_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_pedido_validate_valor_cb

  // ---------- Validate prazo_entrega
  function do_ajax_form_cliente_pedido_validate_prazo_entrega()
  {
    var nomeCampo_prazo_entrega = "prazo_entrega";
    var var_prazo_entrega = scAjaxGetFieldText(nomeCampo_prazo_entrega);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_pedido_validate_prazo_entrega(var_prazo_entrega, var_script_case_init, do_ajax_form_cliente_pedido_validate_prazo_entrega_cb);
  } // do_ajax_form_cliente_pedido_validate_prazo_entrega

  function do_ajax_form_cliente_pedido_validate_prazo_entrega_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_pedido_validate_prazo_entrega_cb

  // ---------- Refresh regiao
  function do_ajax_form_cliente_pedido_refresh_regiao()
  {
    var var_regiao = scAjaxGetFieldSelect("regiao");
    var var_nmgp_refresh_fields = "id_produtor";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cliente_pedido_refresh_regiao(var_regiao, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_cliente_pedido_refresh_regiao_cb);
  } // do_ajax_form_cliente_pedido_refresh_regiao

  function do_ajax_form_cliente_pedido_refresh_regiao_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_cliente_pedido_refresh_id_produtor();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_pedido_refresh_regiao_cb

  // ---------- Refresh id_produtor
  function do_ajax_form_cliente_pedido_refresh_id_produtor()
  {
    var var_id_produtor = scAjaxGetFieldSelect("id_produtor");
    var var_nmgp_refresh_fields = "id_produto";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cliente_pedido_refresh_id_produtor(var_id_produtor, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_cliente_pedido_refresh_id_produtor_cb);
  } // do_ajax_form_cliente_pedido_refresh_id_produtor

  function do_ajax_form_cliente_pedido_refresh_id_produtor_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_pedido_refresh_id_produtor_cb

  // ---------- Event onchange quantidade
  function do_ajax_form_cliente_pedido_event_quantidade_onchange()
  {
    var var_id_produtor = scAjaxGetFieldSelect("id_produtor");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cliente_pedido_event_quantidade_onchange(var_id_produtor, var_id_produto, var_valor, var_quantidade, var_script_case_init, do_ajax_form_cliente_pedido_event_quantidade_onchange_cb);
  } // do_ajax_form_cliente_pedido_event_quantidade_onchange

  function do_ajax_form_cliente_pedido_event_quantidade_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "quantidade";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cliente_pedido_event_quantidade_onchange_cb_after_alert);
  } // do_ajax_form_cliente_pedido_event_quantidade_onchange_cb
  function do_ajax_form_cliente_pedido_event_quantidade_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cliente_pedido_event_quantidade_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cliente_pedido_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cliente_pedido_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_cliente_pedido_submit_form(var_id_cliente_pedido, var_regiao, var_id_produtor, var_id_produto, var_quantidade, var_valor, var_prazo_entrega, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cliente_pedido_submit_form_cb);
  } // do_ajax_form_cliente_pedido_submit_form

  function do_ajax_form_cliente_pedido_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cliente_pedido_submit_form_cb_after_alert);
  } // do_ajax_form_cliente_pedido_submit_form_cb
  function do_ajax_form_cliente_pedido_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cliente_pedido_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cliente_pedido_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_cliente_pedido_navigate_form, function() {});
    } else {
      perform_ajax_form_cliente_pedido_navigate_form();
    }
  }

  function perform_ajax_form_cliente_pedido_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cliente_pedido_navigate_form(var_id_cliente_pedido, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cliente_pedido_navigate_form_cb);
  } // do_ajax_form_cliente_pedido_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_pedido']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cliente_pedido_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cliente_pedido_navigate_form_cb_after_alert);
  } // do_ajax_form_cliente_pedido_navigate_form_cb
  function do_ajax_form_cliente_pedido_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_cliente_pedido_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cliente_pedido_navigate_form_cb_after_alert

  function sc_hide_form_cliente_pedido_form()
  {
