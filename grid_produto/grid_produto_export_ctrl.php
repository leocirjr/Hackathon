<?php
@session_start() ;
$_SESSION['scriptcase']['grid_produto']['sc_process_barr'] = true;
require_once('../grid_produto/index.php');
unset($_SESSION['scriptcase']['grid_produto']['sc_process_barr']);
$ExportCtrl = new grid_produto_export_control;
$ExportCtrl->Export_barr();

class grid_produto_export_control
{
