<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_produto']['glo_nm_perfil']          = "conn_postgres";
...
// 
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_produto']['sub_cons_schema_all']))
      { 
         $this->str_schema_all    = $_SESSION['sc_session'][$this->sc_page]['grid_produto']['sub_cons_schema_all'];
         $this->str_schema_filter = $_SESSION['sc_session'][$this->sc_page]['grid_produto']['sub_cons_schema_filter'];
      } 
    ...
    if (!$_SESSION['sc_session'][$this->sc_page]['grid_produto']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_produto']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_produto']['grid_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['grid_produto']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
      if (isset($_GET['nmgp_opcao']) && $_GET['nmgp_opcao'] == "ajax_aut_comp_dyn_search")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_produto']['dyn_search_aut_comp']['cmp'] = $_GET['field'];
          $_SESSION['sc_session'][$this->sc_page]['grid_produto']['opcao'] = $_GET['origem'];
...
<?php
      ...
      if (is_file($this->root . $this->path_link . "_lib/_app_data/form_produto_ini.php"))
      {
          require($this->root . $this->path_link . "_lib/_app_data/form_produto_ini.php");
      ...
      $this->sc_lig_target["A_@scinf__@scinf_form_produto"] = '_self';
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
      ...
      {
          $this->nm_tabela = "\"public\".view_produto"; 
      }
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_produto']['glo_nm_conexao'], $this->root . $this->path_prod, 'showrural', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle($linhas = 0)
   {
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_produto']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_produto']['label'] = "Produtos - Indicação Geográfica";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['embutida_opcao']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['embutida_opcao'] = "";
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['field_order'][] = "id_produto";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['field_order'][] = "produto";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['field_order'][] = "descricao";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['field_order'][] = "categoria";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['field_order'][] = "tipo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['field_order'][] = "un";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['field_order'][] = "indicacao_geografica";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['usr_cmp_sel']['indicacao_geografica'] = "off";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opc_liga']['inicial'];
              $_SESSION['sc_session'][$script_case_init]['grid_produto']['orig_pesq'] = "grid";
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "grid_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "grid_search_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "grid_search")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "grid_search_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['orig_pesq'] = 'res';
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "grid_search_change_fil" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "grid_search_change_fil_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "grid_search_change_fil")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['opcao'] == "grid_search_change_fil_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['orig_pesq'] = 'res';
          } 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_grid'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_grid'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_grid'] . ")"; 
              }
          }
      ...
      foreach ($fields as $field) {
          ...
          {
              $this->SC_monta_condicao($comando, "id_produto", $arg_search, str_replace(",", ".", $data_search));
          }
          ...
          if ($field == "SC_all_Cmp" || $field == "indicacao_geografica") 
          {
              $this->SC_monta_condicao($comando, "indicacao_geografica", $arg_search, $data_search, "BPCHAR", false);
          }
      }
      if (empty($comando)) 
      {
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_grid'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['where_pesq_grid'] . ")";
      }
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           $dats = explode("_DYN_", $cada_f);
           if ($dats[1] == "del_grid_search_all")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'] as $ind => $dados)
               {
                   $this->proc_del_grid_search($ind, true);
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq']);
               continue;
           }
           ...
           {
               $busca[$dats[0]] = $dats[1];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
               if (isset($fields[$ix]['vls'][1]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
      }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca'][$ind] = $dados;
      }
      if (!$_SESSION['scriptcase']['proc_mobile']) 
      { 
          require_once($this->Ini->path_aplicacao . "grid_produto_pesq.class.php"); 
   ...
   {
      if (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca'][$cmp_del]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca'][$cmp_del] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca'][$cmp_del . "_input_2"] = array();
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca'][$cmp_del] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca'][$cmp_del . "_input_2"] = "";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['campos_busca'][$cmp_del . "_cond"] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['grid_pesq'][$cmp_del]);
   }
...
<HEAD>
 <TITLE>Produtos - Indicação Geográfica :: Doc</TITLE>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_produto']['glo_nm_path_imag_temp'] . "/sc_apl_default_showrural.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_produto']['glo_nm_path_imag_temp'] . "/sc_apl_default_showrural.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_showrural'])) {
               $_SESSION['scriptcase']['grid_produto']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_showrural'];
           }
       }
   }
   ...
   if (isset($_SESSION['scriptcase']['grid_produto']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['grid_produto']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc9_SweetGoldenSand/Sc9_SweetGoldenSand";
...
// 
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['grid_produto'] = "on";
       } 
       if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['grid_produto'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['grid_produto']['opc_psq'] && !isset($_SESSION['scriptcase']['grid_produto']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_produto']) || $_SESSION['scriptcase']['sc_apl_seg']['grid_produto'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['grid_produto']['iframe_menu']) ? false : true;
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['grid_produto']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_produto']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['grid_produto']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_produto']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
...
<?php
      ...
      if ('ajax_fixed_columns_grid_save' == $nmgp_opcao) {
          _d79e692a9432ea2fe37c7f49f5444cd1_saveFixedColumnsGrid($_POST['fixed_index'], $_POST['fixed_action'], $_POST['script_case_init']);
      }
      if ('ajax_fixed_columns_grid_load' == $nmgp_opcao) {
          _d79e692a9432ea2fe37c7f49f5444cd1_loadFixedColumnsGrid($_POST['script_case_init']);
      }
...
<?php
    ...
    function _d79e692a9432ea2fe37c7f49f5444cd1_initializeFixedColumnsGrid($script_case_init)
    {
        if (!isset($_SESSION['sc_session'][$script_case_init]['grid_produto']['fixed_columns_grid'])) {
            $_SESSION['sc_session'][$script_case_init]['grid_produto']['fixed_columns_grid'] = '';
        }
    }

    function _d79e692a9432ea2fe37c7f49f5444cd1_saveFixedColumnsGrid($index, $action, $script_case_init)
    {
        _d79e692a9432ea2fe37c7f49f5444cd1_initializeFixedColumnsGrid($script_case_init);

        if ('on' == $action) {
            $_SESSION['sc_session'][$script_case_init]['grid_produto']['fixed_columns_grid'] = $index;
        } elseif (0 < $index) {
            $_SESSION['sc_session'][$script_case_init]['grid_produto']['fixed_columns_grid'] = $index - 1;
        } else {
            $_SESSION['sc_session'][$script_case_init]['grid_produto']['fixed_columns_grid'] = '';
        }
    ...
    function _d79e692a9432ea2fe37c7f49f5444cd1_loadFixedColumnsGrid($script_case_init)
    {
        _d79e692a9432ea2fe37c7f49f5444cd1_initializeFixedColumnsGrid($script_case_init);
        ...
        echo json_encode(
            array(
                'status' => 'ok',
                'last_index' =>$_SESSION['sc_session'][$script_case_init]['grid_produto']['fixed_columns_grid']
            )
        );
        exit;
    }
