...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "id_produto";$Nm_numeric[] = "id_produto";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_categoria_cond" name="categoria_cond" onChange="nm_campos_between(document.getElementById('id_vis_categoria'), this, 'categoria')">
      ...
      <br><span id="id_hide_categoria"  <?php echo $str_hide_categoria?>><?php
      if ($categoria != "")
      {
      $categoria_look = (is_string($categoria) ? substr($this->Db->qstr($categoria), 1, -1) : $categoria); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_produto_cond" name="id_produto_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_produto'), this, 'id_produto')">
      ...
      <br><span id="id_hide_id_produto"  <?php echo $str_hide_id_produto?>><INPUT  type="text" id="SC_id_produto" name="id_produto" value="<?php echo NM_encode_input($id_produto) ?>" size=9 alt="{datatype: 'integer', maxLength: 9, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_produto_cond" name="produto_cond" onChange="nm_campos_between(document.getElementById('id_vis_produto'), this, 'produto')">
      ...
      <br><span id="id_hide_produto"  <?php echo $str_hide_produto?>><?php
      if ($produto != "")
      {
      $produto_look = (is_string($produto) ? substr($this->Db->qstr($produto), 1, -1) : $produto); 
      $nmgp_def_dados = array(); 
