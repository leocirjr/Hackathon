...
$_SESSION['scriptcase']['grid_produto']['contr_erro'] = 'off'; 
      ...
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_produto']['rtf_name'] .= ".rtf";
          }
   ...
   function NM_export_id_produto()
   {
         ...
         $this->id_produto = str_replace('<', '&lt;', $this->id_produto);
         $this->id_produto = str_replace('>', '&gt;', $this->id_produto);
         $this->Texto_tag .= "<td>" . $this->id_produto . "</td>\r\n";
   }
   //----- produto
   function NM_export_produto()
   {
         ...
         $this->produto = str_replace('<', '&lt;', $this->produto);
         $this->produto = str_replace('>', '&gt;', $this->produto);
         $this->Texto_tag .= "<td>" . $this->produto . "</td>\r\n";
   }
   //----- descricao
   ...
   function NM_export_un()
   {
         ...
         $this->un = str_replace('<', '&lt;', $this->un);
         $this->un = str_replace('>', '&gt;', $this->un);
         $this->Texto_tag .= "<td>" . $this->un . "</td>\r\n";
   }
   ...
   function NM_export_indicacao_geografica()
   {
         ...
         $this->indicacao_geografica = str_replace('<', '&lt;', $this->indicacao_geografica);
         $this->indicacao_geografica = str_replace('>', '&gt;', $this->indicacao_geografica);
         $this->Texto_tag .= "<td>" . $this->indicacao_geografica . "</td>\r\n";
   }
...
<HEAD>
 <TITLE>Produtos - Indicação Geográfica :: RTF</TITLE>
