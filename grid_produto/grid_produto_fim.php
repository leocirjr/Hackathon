...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["showrural_____grid_produto"]))
   {
      unset($_SESSION['session_sec_aplicacao']["showrural_____grid_produto"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_produto'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_produto']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_produto']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_produto']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_produto']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_produto']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_produto']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_produto']['embutida_filho'] as $ind => $sc_init)
          {
