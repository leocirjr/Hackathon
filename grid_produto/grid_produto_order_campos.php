...
<?php
   ...
   $Ord_Cmp = new grid_produto_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_produto_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_produto'] = "id_produto";
   $tab_labels["id_produto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["id_produto"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["id_produto"] : "#";
   $tab_ger_campos['produto'] = "on";
   $tab_def_campos['produto'] = "produto";
   $tab_labels["produto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto"] : "Produto";
   $tab_ger_campos['descricao'] = "on";
   $tab_def_campos['descricao'] = "descricao";
   $tab_labels["descricao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["descricao"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["descricao"] : "Descrição";
   $tab_ger_campos['categoria'] = "on";
   $tab_def_campos['categoria'] = "categoria";
   $tab_labels["categoria"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["categoria"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["categoria"] : "Categoria";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['un'] = "on";
   $tab_def_campos['un'] = "un";
   $tab_labels["un"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["un"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["un"] : "UN";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_produto']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_produto']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_produto_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_produto']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
