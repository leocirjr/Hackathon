...
$_SESSION['scriptcase']['grid_cliente']['contr_erro'] = 'off'; 
      ...
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['rtf_name'] .= ".rtf";
          }
