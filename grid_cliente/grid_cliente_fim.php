...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["showrural_____grid_cliente"]))
   {
      unset($_SESSION['session_sec_aplicacao']["showrural_____grid_cliente"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cliente']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cliente']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cliente']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cliente']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cliente']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cliente']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cliente']['embutida_filho'] as $ind => $sc_init)
          {
