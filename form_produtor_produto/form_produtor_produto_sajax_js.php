  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_produtor_produto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_produtor_produto_form();
	}
...
?>
  ...
  // ---------- Validate id_pessoa_produto_
  function do_ajax_form_produtor_produto_validate_id_pessoa_produto_(iNumLinha)
  {
    var nomeCampo_id_pessoa_produto_ = "id_pessoa_produto_" + iNumLinha;
    var var_id_pessoa_produto_ = scAjaxGetFieldHidden(nomeCampo_id_pessoa_produto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_produto_validate_id_pessoa_produto_(var_id_pessoa_produto_, iNumLinha, var_script_case_init, do_ajax_form_produtor_produto_validate_id_pessoa_produto__cb);
  } // do_ajax_form_produtor_produto_validate_id_pessoa_produto_

  function do_ajax_form_produtor_produto_validate_id_pessoa_produto__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_pessoa_produto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_pessoa_produto_";
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_produto_validate_id_pessoa_produto__cb

  // ---------- Validate id_produto_
  function do_ajax_form_produtor_produto_validate_id_produto_(iNumLinha)
  {
    var nomeCampo_id_produto_ = "id_produto_" + iNumLinha;
    var var_id_produto_ = scAjaxGetFieldSelect(nomeCampo_id_produto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_produto_validate_id_produto_(var_id_produto_, iNumLinha, var_script_case_init, do_ajax_form_produtor_produto_validate_id_produto__cb);
  } // do_ajax_form_produtor_produto_validate_id_produto_

  function do_ajax_form_produtor_produto_validate_id_produto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_produto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_produto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_produto_validate_id_produto__cb

  // ---------- Validate data_certificacao_
  function do_ajax_form_produtor_produto_validate_data_certificacao_(iNumLinha)
  {
    var nomeCampo_data_certificacao_ = "data_certificacao_" + iNumLinha;
    var var_data_certificacao_ = scAjaxGetFieldText(nomeCampo_data_certificacao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_produto_validate_data_certificacao_(var_data_certificacao_, iNumLinha, var_script_case_init, do_ajax_form_produtor_produto_validate_data_certificacao__cb);
  } // do_ajax_form_produtor_produto_validate_data_certificacao_

  function do_ajax_form_produtor_produto_validate_data_certificacao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "data_certificacao_" + iLineNumber;
    }
    else
    {
      sFieldValid = "data_certificacao_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_produto_validate_data_certificacao__cb

  // ---------- Validate validade_certificacao_
  function do_ajax_form_produtor_produto_validate_validade_certificacao_(iNumLinha)
  {
    var nomeCampo_validade_certificacao_ = "validade_certificacao_" + iNumLinha;
    var var_validade_certificacao_ = scAjaxGetFieldText(nomeCampo_validade_certificacao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_produto_validate_validade_certificacao_(var_validade_certificacao_, iNumLinha, var_script_case_init, do_ajax_form_produtor_produto_validate_validade_certificacao__cb);
  } // do_ajax_form_produtor_produto_validate_validade_certificacao_

  function do_ajax_form_produtor_produto_validate_validade_certificacao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "validade_certificacao_" + iLineNumber;
    }
    else
    {
      sFieldValid = "validade_certificacao_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_produto_validate_validade_certificacao__cb

  // ---------- Validate preco_medio_
  function do_ajax_form_produtor_produto_validate_preco_medio_(iNumLinha)
  {
    var nomeCampo_preco_medio_ = "preco_medio_" + iNumLinha;
    var var_preco_medio_ = scAjaxGetFieldText(nomeCampo_preco_medio_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_produto_validate_preco_medio_(var_preco_medio_, iNumLinha, var_script_case_init, do_ajax_form_produtor_produto_validate_preco_medio__cb);
  } // do_ajax_form_produtor_produto_validate_preco_medio_

  function do_ajax_form_produtor_produto_validate_preco_medio__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "preco_medio_" + iLineNumber;
    }
    else
    {
      sFieldValid = "preco_medio_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_produto_validate_preco_medio__cb

  // ---------- Validate quantidade_minima_pedido_
  function do_ajax_form_produtor_produto_validate_quantidade_minima_pedido_(iNumLinha)
  {
    var nomeCampo_quantidade_minima_pedido_ = "quantidade_minima_pedido_" + iNumLinha;
    var var_quantidade_minima_pedido_ = scAjaxGetFieldText(nomeCampo_quantidade_minima_pedido_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_produto_validate_quantidade_minima_pedido_(var_quantidade_minima_pedido_, iNumLinha, var_script_case_init, do_ajax_form_produtor_produto_validate_quantidade_minima_pedido__cb);
  } // do_ajax_form_produtor_produto_validate_quantidade_minima_pedido_

  function do_ajax_form_produtor_produto_validate_quantidade_minima_pedido__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "quantidade_minima_pedido_" + iLineNumber;
    }
    else
    {
      sFieldValid = "quantidade_minima_pedido_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_produto_validate_quantidade_minima_pedido__cb

  // ---------- Validate prazo_dias_envio_
  function do_ajax_form_produtor_produto_validate_prazo_dias_envio_(iNumLinha)
  {
    var nomeCampo_prazo_dias_envio_ = "prazo_dias_envio_" + iNumLinha;
    var var_prazo_dias_envio_ = scAjaxGetFieldText(nomeCampo_prazo_dias_envio_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_produto_validate_prazo_dias_envio_(var_prazo_dias_envio_, iNumLinha, var_script_case_init, do_ajax_form_produtor_produto_validate_prazo_dias_envio__cb);
  } // do_ajax_form_produtor_produto_validate_prazo_dias_envio_

  function do_ajax_form_produtor_produto_validate_prazo_dias_envio__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "prazo_dias_envio_" + iLineNumber;
    }
    else
    {
      sFieldValid = "prazo_dias_envio_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_produto_validate_prazo_dias_envio__cb

  // ---------- Validate requisito_transporte_
  function do_ajax_form_produtor_produto_validate_requisito_transporte_(iNumLinha)
  {
    var nomeCampo_requisito_transporte_ = "requisito_transporte_" + iNumLinha;
    var var_requisito_transporte_ = scAjaxGetFieldText(nomeCampo_requisito_transporte_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_produto_validate_requisito_transporte_(var_requisito_transporte_, iNumLinha, var_script_case_init, do_ajax_form_produtor_produto_validate_requisito_transporte__cb);
  } // do_ajax_form_produtor_produto_validate_requisito_transporte_

  function do_ajax_form_produtor_produto_validate_requisito_transporte__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "requisito_transporte_" + iLineNumber;
    }
    else
    {
      sFieldValid = "requisito_transporte_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produtor_produto_validate_requisito_transporte__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_produtor_produto_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_produtor_produto_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_produtor_produto_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_produtor_produto_add_new_line_cb);
  } // do_ajax_form_produtor_produto_add_new_line

  function do_ajax_form_produtor_produto_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    scFixCol_loadState();
  } // do_ajax_form_produtor_produto_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_produtor_produto_backup_line(iNumLinha)
  {
    var var_id_pessoa_produto_ = scAjaxGetFieldHidden("id_pessoa_produto_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produtor_produto_backup_line(var_id_pessoa_produto_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_produtor_produto_backup_line_cb);
  } // do_ajax_form_produtor_produto_backup_line

  function do_ajax_form_produtor_produto_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_produtor_produto_backup_line_cb

  function do_ajax_form_produtor_produto_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
    ...
    scAjaxHideErrorDisplay("table");
  } // do_ajax_form_produtor_produto_cancel_insert

  function do_ajax_form_produtor_produto_cancel_update(iSeqVert)
  {
    do_ajax_form_produtor_produto_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_produtor_produto_cancel_update

  function do_ajax_form_produtor_produto_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_produtor_produto_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_produtor_produto_table_refresh()
  {
    var var_id_pessoa_produto_ = document.F2.id_pessoa_produto_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_produtor_produto_table_refresh(var_id_pessoa_produto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_produtor_produto_table_refresh_cb);
  } //  do_ajax_form_produtor_produto_table_refresh

  function do_ajax_form_produtor_produto_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_pessoa_produto_.value = scAjaxGetKeyValue("id_pessoa_produto_");
    ...
    scAjaxAlert(do_ajax_form_produtor_produto_table_refresh_cb_after_alert);
  } // do_ajax_form_produtor_produto_table_refresh_cb
  function do_ajax_form_produtor_produto_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_produtor_produto_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_produtor_produto_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_produtor_produto_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_pessoa_produto_ = scAjaxGetFieldHidden("id_pessoa_produto_" + iNumLinha);
    var var_id_produto_ = scAjaxGetFieldSelect("id_produto_" + iNumLinha);
    var var_data_certificacao_ = scAjaxGetFieldText("data_certificacao_" + iNumLinha);
    var var_validade_certificacao_ = scAjaxGetFieldText("validade_certificacao_" + iNumLinha);
    var var_preco_medio_ = scAjaxGetFieldText("preco_medio_" + iNumLinha);
    var var_quantidade_minima_pedido_ = scAjaxGetFieldText("quantidade_minima_pedido_" + iNumLinha);
    var var_prazo_dias_envio_ = scAjaxGetFieldText("prazo_dias_envio_" + iNumLinha);
    var var_requisito_transporte_ = scAjaxGetFieldText("requisito_transporte_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_produtor_produto_submit_form(var_id_pessoa_produto_, var_id_produto_, var_data_certificacao_, var_validade_certificacao_, var_preco_medio_, var_quantidade_minima_pedido_, var_prazo_dias_envio_, var_requisito_transporte_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_produtor_produto_submit_form_cb);
  } // do_ajax_form_produtor_produto_submit_form

  function do_ajax_form_produtor_produto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_produtor_produto_submit_form_cb_after_alert);
  } // do_ajax_form_produtor_produto_submit_form_cb
  function do_ajax_form_produtor_produto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_produtor_produto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_produtor_produto_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_produtor_produto_navigate_form, function() {});
    } else {
      perform_ajax_form_produtor_produto_navigate_form();
    }
  }

  function perform_ajax_form_produtor_produto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_produtor_produto_cancel_insert(sc_form_produtor_produto_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_produtor_produto_navigate_form(var_id_pessoa_produto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_produtor_produto_navigate_form_cb);
  } // do_ajax_form_produtor_produto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_produtor_produto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_produtor_produto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_pessoa_produto_.value = scAjaxGetKeyValue("id_pessoa_produto_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_produtor_produto_navigate_form_cb_after_alert);
  } // do_ajax_form_produtor_produto_navigate_form_cb
  function do_ajax_form_produtor_produto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_produtor_produto_navigate_form_cb_after_alert

    function sc_form_produtor_produto_get_last_line_number()
    {
    ...
    } //sc_form_produtor_produto_get_last_line_number

  function sc_hide_form_produtor_produto_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_pessoa_produto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_produto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "data_certificacao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "validade_certificacao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "preco_medio_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "quantidade_minima_pedido_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "prazo_dias_envio_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "requisito_transporte_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_pessoa_produto_" + iNumLinha] = {"label": "#<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["id_produto_" + iNumLinha] = {"label": "Produto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["data_certificacao_" + iNumLinha] = {"label": "Data Certificação<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["validade_certificacao_" + iNumLinha] = {"label": "Validade Certificação<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["preco_medio_" + iNumLinha] = {"label": "Preço<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["quantidade_minima_pedido_" + iNumLinha] = {"label": "Quantidade Mínima Pedido<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["prazo_dias_envio_" + iNumLinha] = {"label": "Prazo em Dias Envio<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_error_list["requisito_transporte_" + iNumLinha] = {"label": "Requisitos de Transporte<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 0};
    ajax_field_mult["id_pessoa_produto_"][iNumLinha] = "id_pessoa_produto_" + iNumLinha;
    ajax_field_mult["id_produto_"][iNumLinha] = "id_produto_" + iNumLinha;
    ajax_field_mult["data_certificacao_"][iNumLinha] = "data_certificacao_" + iNumLinha;
    ajax_field_mult["validade_certificacao_"][iNumLinha] = "validade_certificacao_" + iNumLinha;
    ajax_field_mult["preco_medio_"][iNumLinha] = "preco_medio_" + iNumLinha;
    ajax_field_mult["quantidade_minima_pedido_"][iNumLinha] = "quantidade_minima_pedido_" + iNumLinha;
    ajax_field_mult["prazo_dias_envio_"][iNumLinha] = "prazo_dias_envio_" + iNumLinha;
    ajax_field_mult["requisito_transporte_"][iNumLinha] = "requisito_transporte_" + iNumLinha;
    ajax_field_id["id_pessoa_produto_" + iNumLinha] = new Array("hidden_field_label_id_pessoa_produto_", "hidden_field_data_id_pessoa_produto_" + iNumLinha);
    ajax_field_id["id_produto_" + iNumLinha] = new Array("hidden_field_label_id_produto_", "hidden_field_data_id_produto_" + iNumLinha);
    ajax_field_id["data_certificacao_" + iNumLinha] = new Array("hidden_field_label_data_certificacao_", "hidden_field_data_data_certificacao_" + iNumLinha);
    ajax_field_id["validade_certificacao_" + iNumLinha] = new Array("hidden_field_label_validade_certificacao_", "hidden_field_data_validade_certificacao_" + iNumLinha);
    ajax_field_id["preco_medio_" + iNumLinha] = new Array("hidden_field_label_preco_medio_", "hidden_field_data_preco_medio_" + iNumLinha);
    ajax_field_id["quantidade_minima_pedido_" + iNumLinha] = new Array("hidden_field_label_quantidade_minima_pedido_", "hidden_field_data_quantidade_minima_pedido_" + iNumLinha);
    ajax_field_id["prazo_dias_envio_" + iNumLinha] = new Array("hidden_field_label_prazo_dias_envio_", "hidden_field_data_prazo_dias_envio_" + iNumLinha);
    ajax_field_id["requisito_transporte_" + iNumLinha] = new Array("hidden_field_label_requisito_transporte_", "hidden_field_data_requisito_transporte_" + iNumLinha);
    ajax_error_count["id_pessoa_produto_" + iNumLinha] = "off";
    ajax_error_count["id_produto_" + iNumLinha] = "off";
    ajax_error_count["data_certificacao_" + iNumLinha] = "off";
    ajax_error_count["validade_certificacao_" + iNumLinha] = "off";
    ajax_error_count["preco_medio_" + iNumLinha] = "off";
    ajax_error_count["quantidade_minima_pedido_" + iNumLinha] = "off";
    ajax_error_count["prazo_dias_envio_" + iNumLinha] = "off";
    ajax_error_count["requisito_transporte_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_pessoa_produto_" + iNumLinha] = "on";
    ajax_read_only["id_produto_" + iNumLinha] = "off";
    ajax_read_only["data_certificacao_" + iNumLinha] = "off";
    ajax_read_only["validade_certificacao_" + iNumLinha] = "off";
    ajax_read_only["preco_medio_" + iNumLinha] = "off";
    ajax_read_only["quantidade_minima_pedido_" + iNumLinha] = "off";
    ajax_read_only["prazo_dias_envio_" + iNumLinha] = "off";
    ajax_read_only["requisito_transporte_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_pessoa_produto_" + iNumLinha] = "on";
    ajax_read_only["id_produto_" + iNumLinha] = "on";
    ajax_read_only["data_certificacao_" + iNumLinha] = "on";
    ajax_read_only["validade_certificacao_" + iNumLinha] = "on";
    ajax_read_only["preco_medio_" + iNumLinha] = "on";
    ajax_read_only["quantidade_minima_pedido_" + iNumLinha] = "on";
    ajax_read_only["prazo_dias_envio_" + iNumLinha] = "on";
    ajax_read_only["requisito_transporte_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_pessoa_produto_" + iNumLinha] = null;
    ajax_error_list["id_produto_" + iNumLinha] = null;
    ajax_error_list["data_certificacao_" + iNumLinha] = null;
    ajax_error_list["validade_certificacao_" + iNumLinha] = null;
    ajax_error_list["preco_medio_" + iNumLinha] = null;
    ajax_error_list["quantidade_minima_pedido_" + iNumLinha] = null;
    ajax_error_list["prazo_dias_envio_" + iNumLinha] = null;
    ajax_error_list["requisito_transporte_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_pessoa_produto_": new Array(),
    "id_produto_": new Array(),
    "data_certificacao_": new Array(),
    "validade_certificacao_": new Array(),
    "preco_medio_": new Array(),
    "quantidade_minima_pedido_": new Array(),
    "prazo_dias_envio_": new Array(),
    "requisito_transporte_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_pessoa_produto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_pessoa_produto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_pessoa_produto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_pessoa_produto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_pessoa_produto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["id_produto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_produto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_produto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_produto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_produto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["data_certificacao_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["data_certificacao_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["data_certificacao_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["data_certificacao_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["data_certificacao_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["validade_certificacao_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["validade_certificacao_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["validade_certificacao_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["validade_certificacao_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["validade_certificacao_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["preco_medio_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["preco_medio_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["preco_medio_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["preco_medio_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["preco_medio_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["quantidade_minima_pedido_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["quantidade_minima_pedido_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["quantidade_minima_pedido_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["quantidade_minima_pedido_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["quantidade_minima_pedido_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["prazo_dias_envio_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["prazo_dias_envio_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["prazo_dias_envio_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["prazo_dias_envio_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["prazo_dias_envio_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["requisito_transporte_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["requisito_transporte_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["requisito_transporte_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["requisito_transporte_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["requisito_transporte_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_pessoa_produto_'])) ? $this->nmgp_cmp_readonly['id_pessoa_produto_'] : 'on';
?>
    scAjaxFieldRead("id_pessoa_produto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_produto_'])) ? $this->nmgp_cmp_readonly['id_produto_'] : 'off';
?>
    scAjaxFieldRead("id_produto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['data_certificacao_'])) ? $this->nmgp_cmp_readonly['data_certificacao_'] : 'off';
?>
    scAjaxFieldRead("data_certificacao_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['validade_certificacao_'])) ? $this->nmgp_cmp_readonly['validade_certificacao_'] : 'off';
?>
    scAjaxFieldRead("validade_certificacao_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['preco_medio_'])) ? $this->nmgp_cmp_readonly['preco_medio_'] : 'off';
?>
    scAjaxFieldRead("preco_medio_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['quantidade_minima_pedido_'])) ? $this->nmgp_cmp_readonly['quantidade_minima_pedido_'] : 'off';
?>
    scAjaxFieldRead("quantidade_minima_pedido_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['prazo_dias_envio_'])) ? $this->nmgp_cmp_readonly['prazo_dias_envio_'] : 'off';
?>
    scAjaxFieldRead("prazo_dias_envio_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['requisito_transporte_'])) ? $this->nmgp_cmp_readonly['requisito_transporte_'] : 'off';
?>
    scAjaxFieldRead("requisito_transporte_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_pessoa_produto_" + iSeq, "on");
    scAjaxFieldRead("id_produto_" + iSeq, "on");
    scAjaxFieldRead("data_certificacao_" + iSeq, "on");
    scAjaxFieldRead("validade_certificacao_" + iSeq, "on");
    scAjaxFieldRead("preco_medio_" + iSeq, "on");
    scAjaxFieldRead("quantidade_minima_pedido_" + iSeq, "on");
    scAjaxFieldRead("prazo_dias_envio_" + iSeq, "on");
    scAjaxFieldRead("requisito_transporte_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_pessoa_produto_" + iRow] || "on" == ajax_error_count["id_produto_" + iRow] || "on" == ajax_error_count["data_certificacao_" + iRow] || "on" == ajax_error_count["validade_certificacao_" + iRow] || "on" == ajax_error_count["preco_medio_" + iRow] || "on" == ajax_error_count["quantidade_minima_pedido_" + iRow] || "on" == ajax_error_count["prazo_dias_envio_" + iRow] || "on" == ajax_error_count["requisito_transporte_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_pessoa_produto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_produto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_data_certificacao_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_validade_certificacao_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_preco_medio_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_quantidade_minima_pedido_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_prazo_dias_envio_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_requisito_transporte_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_pessoa_produto_" + iRow] && "off" == ajax_error_count["id_produto_" + iRow] && "off" == ajax_error_count["data_certificacao_" + iRow] && "off" == ajax_error_count["validade_certificacao_" + iRow] && "off" == ajax_error_count["preco_medio_" + iRow] && "off" == ajax_error_count["quantidade_minima_pedido_" + iRow] && "off" == ajax_error_count["prazo_dias_envio_" + iRow] && "off" == ajax_error_count["requisito_transporte_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_pessoa_produto_" + iRow] = "off";
        ajax_error_count["id_produto_" + iRow] = "off";
        ajax_error_count["data_certificacao_" + iRow] = "off";
        ajax_error_count["validade_certificacao_" + iRow] = "off";
        ajax_error_count["preco_medio_" + iRow] = "off";
        ajax_error_count["quantidade_minima_pedido_" + iRow] = "off";
        ajax_error_count["prazo_dias_envio_" + iRow] = "off";
        ajax_error_count["requisito_transporte_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_pessoa_produto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_produto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_data_certificacao_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_validade_certificacao_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_preco_medio_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_quantidade_minima_pedido_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_prazo_dias_envio_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_requisito_transporte_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("validade_certificacao_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("quantidade_minima_pedido_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("requisito_transporte_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
