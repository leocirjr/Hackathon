...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu']['glo_nm_perfil']         = "conn_postgres";
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
 ...
 <META http <META http <META http <META http <META http      <link rel="shortcut icon" href="../_lib/img/grp__NM__bg__NM__cropped-Logo-SRC-32x32.png">
...
if(is_file($path_apls . $this->tab_grupo[0] . '_lib/_app_data/blank_background_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] . '_lib/_app_data/blank_background_ini.php');
    ...
    {
      if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_background']))
      {
        $_SESSION['scriptcase']['sc_apl_seg']['blank_background'] = "on";
      }
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_produtor_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_produtor_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_produtor']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_cliente_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_cliente_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cliente']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_transportadora_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_transportadora_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_transportadora']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_produto_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_produto_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_produto']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_cliente_pedido_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/grid_cliente_pedido_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cliente_pedido']))
        {
            $_SESSION['scriptcase']['sc_apl_seg']['grid_cliente_pedido'] = "on";
        }
    }
    if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
    { 
...
if (is_file($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_form_sec_groups_ini.php'))
{
    require($path_apls . $this->tab_grupo[0] .'_lib/_app_data/sec_form_sec_groups_ini.php');
    if ((!isset($arr_data['status']) || trim($arr_data['status']) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_form_sec_groups']))
        {
...
<style>
	...
	#idDivMenu .menu .menu-toggler > span, #idDivMenu .menu .menu-toggler > i{
	...
	ul#css3menu1 li.topmenu:hover>a, ul#css3menu1 li.topmenu a.pressed {	
		border-color: #0E472D transparent transparent transparent !important;
	}	
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[4]))
{
 ...
 $nm_var_hint[5] = "Indicação Geográfica";
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_produtor']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_produtor']) == "on")
{
    $menu_menuData['data'] .= "item_9|..|" . $nm_var_lab[1] . "|menu_form_php.php?sc_item_menu=item_9&sc_apl_menu=grid_produtor&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_9|..|" . $nm_var_lab[1] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cliente']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cliente']) == "on")
{
    $menu_menuData['data'] .= "item_10|..|" . $nm_var_lab[2] . "|menu_form_php.php?sc_item_menu=item_10&sc_apl_menu=grid_cliente&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_10|..|" . $nm_var_lab[2] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_transportadora']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_transportadora']) == "on")
{
    $menu_menuData['data'] .= "item_12|..|" . $nm_var_lab[3] . "|menu_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_transportadora&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_12|..|" . $nm_var_lab[3] . "||||_self|disabled\n";
}
$menu_menuData['data'] .= "item_13|.|" . $nm_var_lab[4] . "||" . $nm_var_hint[4] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_produto']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_produto']) == "on")
{
    $menu_menuData['data'] .= "item_11|..|" . $nm_var_lab[5] . "|menu_form_php.php?sc_item_menu=item_11&sc_apl_menu=grid_produto&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_11|..|" . $nm_var_lab[5] . "||||_self|disabled\n";
}
$menu_menuData['data'] .= "item_15|.|" . $nm_var_lab[6] . "||" . $nm_var_hint[6] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cliente_pedido']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cliente_pedido']) == "on")
{
    $menu_menuData['data'] .= "item_14|..|" . $nm_var_lab[7] . "|menu_form_php.php?sc_item_menu=item_14&sc_apl_menu=grid_cliente_pedido&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_14|..|" . $nm_var_lab[7] . "||||_self|disabled\n";
}
$menu_menuData['data'] .= "item_2|.|" . $this->Nm_lang['lang_menu_security'] . "||" . $this->Nm_lang['lang_menu_security'] . "||_self|\n";
...
{
    $menu_menuData['data'] .= "item_3|..|" . $this->Nm_lang['lang_list_users'] . "|menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=sec_grid_sec_users&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_3|..|" . $this->Nm_lang['lang_list_users'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sec_form_sec_groups']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_form_sec_groups']) == "on")
{
    $menu_menuData['data'] .= "item_4|..|" . $this->Nm_lang['lang_list_groups'] . "|menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=sec_form_sec_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_4|..|" . $this->Nm_lang['lang_list_groups'] . "||||_self|disabled\n";
}
$menu_menuData['data'] .= "item_5|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||" . $nm_var_hint[10] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sec_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_sync_apps']) == "on")
{
    $menu_menuData['data'] .= "item_6|..|" . $this->Nm_lang['lang_list_sync_apps'] . "|menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=sec_sync_apps&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_6|..|" . $this->Nm_lang['lang_list_sync_apps'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sec_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_change_pswd']) == "on")
{
    $menu_menuData['data'] .= "item_7|..|" . $this->Nm_lang['lang_change_pswd'] . "|menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=sec_change_pswd&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[12] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_7|..|" . $this->Nm_lang['lang_change_pswd'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['sec_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_Login']) == "on")
{
    $menu_menuData['data'] .= "item_8|.|" . $this->Nm_lang['lang_exit'] . "|menu_form_php.php?sc_item_menu=item_8&sc_apl_menu=sec_Login&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[13] . "||" . $this->menu_target('_parent') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_8|.|" . $this->Nm_lang['lang_exit'] . "||||_parent|disabled\n";
}
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_9&sc_apl_menu=grid_produtor&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_produtor']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_produtor']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_10&sc_apl_menu=grid_cliente&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cliente']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cliente']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_transportadora&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_transportadora']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_transportadora']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$menu_menuData['data'][] = array(
    ...
    'display'     => "text_fontawesomeicon",
    'display_position'=> "text_right",
    'icon_fa'     => "fas fa-lemon",
    'icon_color'     => "",
    'icon_color_hover'     => "",
    'icon_color_disabled'     => "",
);
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_11&sc_apl_menu=grid_produto&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_produto']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_produto']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$menu_menuData['data'][] = array(
    ...
    'display'     => "text_fontawesomeicon",
    'display_position'=> "text_right",
    'icon_fa'     => "fas fa-handshake",
    'icon_color'     => "",
    'icon_color_hover'     => "",
    'icon_color_disabled'     => "",
);
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_14&sc_apl_menu=grid_cliente_pedido&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cliente_pedido']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cliente_pedido']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_menuData['data'][] = array(
        ...
        'display'     => "text_fontawesomeicon",
        'display_position'=> "text_right",
        'icon_fa'     => "fas fa-comments-dollar",
        'icon_color'     => "",
        'icon_color_hover'     => "",
        'icon_color_disabled'     => "",
    );
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=sec_grid_sec_users&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_menuData['data'][] = array(
        ...
        'display'     => "text_fontawesomeicon",
        'display_position'=> "text_right",
        'icon_fa'     => "fas fa-user-edit",
        'icon_color'     => "",
        'icon_color_hover'     => "",
        'icon_color_disabled'     => "",
    );
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=sec_form_sec_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_form_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_form_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=sec_sync_apps&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=sec_change_pswd&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_8&sc_apl_menu=sec_Login&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['sec_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['sec_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank_background']) && $_SESSION['scriptcase']['sc_apl_seg']['blank_background'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu');\" item-href=\"menu_form_php.php?sc_item_menu=menu&sc_apl_menu=blank_background&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_iframe\"";
} 
else
{ 
...
?>
        <td class='sc-layer-0' style='width:5.66%;text-align:center;'>
                        <span class='sc-layer-0-0' style='font-size: 16px;background-color: ;font-family: ;color: #000000;'>   <img src="<?php echo $path_imag_cab ?>/grp__NM__img__NM__cropped-Logo-SRC-32x32.png" border="0"/></span><br/>
  ...
  <div class='mainmenu menu--horizontal'>
      ...
      <div class='menu__container '>
        ...
        <td class='sc-layer-1' style='width:7.89%;text-align:left;'>
                        <span class='sc-layer-1-0' style='font-size: 16px;background-color: ;font-family: ;color: #000000;'><link rel="stylesheet" href="../_lib/libraries/grp/ShowRural//menu/css/menu01.css">
    <div class="right">
            <ul class="menu">
                <li>
                    <a class="menu-toggler" href="#">
                           <img src="<?php echo $path_imag_cab ?>/grp__NM__img__NM__avatar.png" border="0"/>
                        <span {NM_CSS_CAB}><?php echo "" . $_SESSION['usr_name'] . "" ?></span>
                        <i><img src="../_lib/libraries/grp/ShowRural//menu/img/group_expand.png"></i>
                    </a>
                        ...
                        <li class="info">
                            ...
                            <div class="right">
                                <h4>
									...
									<p>
                                    <small><?php echo "" . $_SESSION['usr_email'] . "" ?></small>
									<p>
                                    <small></small>
                                </h4>
                            </div>
...
<script language="javascript" src="../_lib/libraries/grp/ShowRural//menu/js/menu01.js"></script></span><br/>
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_showrural.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_showrural.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu") {
        ...
        if (isset($_COOKIE['sc_actual_lang_showrural'])) {
            $_SESSION['scriptcase']['menu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_showrural'];
        }
    }
}
