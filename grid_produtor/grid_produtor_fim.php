...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["showrural_____grid_produtor"]))
   {
      unset($_SESSION['session_sec_aplicacao']["showrural_____grid_produtor"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_produtor'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_produtor']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_produtor']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_produtor']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_produtor']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_produtor']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_produtor']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_produtor']['embutida_filho'] as $ind => $sc_init)
          {
