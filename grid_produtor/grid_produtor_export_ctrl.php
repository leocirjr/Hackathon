<?php
@session_start() ;
$_SESSION['scriptcase']['grid_produtor']['sc_process_barr'] = true;
require_once('../grid_produtor/index.php');
unset($_SESSION['scriptcase']['grid_produtor']['sc_process_barr']);
$ExportCtrl = new grid_produtor_export_control;
$ExportCtrl->Export_barr();

class grid_produtor_export_control
{
