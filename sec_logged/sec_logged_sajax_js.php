...
?>
  ...
  // ---------- Validate img
  function do_ajax_sec_logged_validate_img()
  {
    var nomeCampo_img = "img";
    var var_img = scAjaxGetFieldText(nomeCampo_img);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_logged_validate_img(var_img, var_script_case_init, do_ajax_sec_logged_validate_img_cb);
  } // do_ajax_sec_logged_validate_img

  function do_ajax_sec_logged_validate_img_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "img";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_logged_validate_img_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_sec_logged_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_sec_logged_submit_form(var_html, var_img, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_sec_logged_submit_form_cb);
