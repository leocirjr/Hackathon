   ...
   function ini_controle()
   {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_edit_users']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_edit_users']['label'] = "Usuários";
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'sec_form_edit_users/sec_form_edit_users_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'sec_form_edit_users_calendar.php');
          }
          exit;
      }
...
//
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['dados_select']['sugestao_senha']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->sugestao_senha = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['dados_select']['sugestao_senha'];
          } 
...
$aLookup[] = array(sec_form_edit_users_pack_protect_string('Sim') => str_replace('<', '&lt;',sec_form_edit_users_pack_protect_string("Sim")));
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['Lookup_modelo_senha'][] = 'Sim';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['modelo_senha']['valList'][$i] = sec_form_edit_users_pack_protect_string($v);
          }
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
             ...
             { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('login', 'name', 'email', 'modelo_senha', 'sugestao_senha', 'pswd', 'confirm_pswd', 'active', 'mfa', 'data_senha', 'data_expirar_senha', 'groups'), $aDoNotUpdate);
              $this->ajax_return_values();
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users']['SC_sep_date1'];
              }
          }
