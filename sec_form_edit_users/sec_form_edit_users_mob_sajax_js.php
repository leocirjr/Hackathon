...
?>
  ...
  // ---------- Validate modelo_senha
  function do_ajax_sec_form_edit_users_mob_validate_modelo_senha()
  {
    var nomeCampo_modelo_senha = "modelo_senha";
    var var_modelo_senha = scAjaxGetFieldCheckbox(nomeCampo_modelo_senha, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_mob_validate_modelo_senha(var_modelo_senha, var_script_case_init, do_ajax_sec_form_edit_users_mob_validate_modelo_senha_cb);
  } // do_ajax_sec_form_edit_users_mob_validate_modelo_senha

  function do_ajax_sec_form_edit_users_mob_validate_modelo_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "modelo_senha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_mob_validate_modelo_senha_cb

  // ---------- Validate sugestao_senha
  function do_ajax_sec_form_edit_users_mob_validate_sugestao_senha()
  {
    var nomeCampo_sugestao_senha = "sugestao_senha";
    var var_sugestao_senha = scAjaxGetFieldHidden(nomeCampo_sugestao_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_mob_validate_sugestao_senha(var_sugestao_senha, var_script_case_init, do_ajax_sec_form_edit_users_mob_validate_sugestao_senha_cb);
  } // do_ajax_sec_form_edit_users_mob_validate_sugestao_senha

  function do_ajax_sec_form_edit_users_mob_validate_sugestao_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sugestao_senha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_mob_validate_sugestao_senha_cb
  ...
  // ---------- Validate mfa
  function do_ajax_sec_form_edit_users_mob_validate_mfa()
  {
    var nomeCampo_mfa = "mfa";
    var var_mfa = scAjaxGetFieldText(nomeCampo_mfa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_mob_validate_mfa(var_mfa, var_script_case_init, do_ajax_sec_form_edit_users_mob_validate_mfa_cb);
  } // do_ajax_sec_form_edit_users_mob_validate_mfa

  function do_ajax_sec_form_edit_users_mob_validate_mfa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mfa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_mob_validate_mfa_cb
  ...
  // ---------- Validate data_senha
  function do_ajax_sec_form_edit_users_mob_validate_data_senha()
  {
    var nomeCampo_data_senha = "data_senha";
    var var_data_senha = scAjaxGetFieldText(nomeCampo_data_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_mob_validate_data_senha(var_data_senha, var_script_case_init, do_ajax_sec_form_edit_users_mob_validate_data_senha_cb);
  } // do_ajax_sec_form_edit_users_mob_validate_data_senha

  function do_ajax_sec_form_edit_users_mob_validate_data_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_senha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_mob_validate_data_senha_cb

  // ---------- Validate data_expirar_senha
  function do_ajax_sec_form_edit_users_mob_validate_data_expirar_senha()
  {
    var nomeCampo_data_expirar_senha = "data_expirar_senha";
    var var_data_expirar_senha = scAjaxGetFieldText(nomeCampo_data_expirar_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_mob_validate_data_expirar_senha(var_data_expirar_senha, var_script_case_init, do_ajax_sec_form_edit_users_mob_validate_data_expirar_senha_cb);
  } // do_ajax_sec_form_edit_users_mob_validate_data_expirar_senha

  function do_ajax_sec_form_edit_users_mob_validate_data_expirar_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_expirar_senha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_mob_validate_data_expirar_senha_cb
  ...
  function do_ajax_sec_form_edit_users_mob_event_login_onchange()
  {
    var var_data_expirar_senha = scAjaxGetFieldText("data_expirar_senha");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_sec_form_edit_users_mob_event_login_onchange(var_data_expirar_senha, var_script_case_init, do_ajax_sec_form_edit_users_mob_event_login_onchange_cb);
  } // do_ajax_sec_form_edit_users_mob_event_login_onchange

  function do_ajax_sec_form_edit_users_mob_event_login_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "login";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_sec_form_edit_users_mob_event_login_onchange_cb_after_alert);
  } // do_ajax_sec_form_edit_users_mob_event_login_onchange_cb
  function do_ajax_sec_form_edit_users_mob_event_login_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_sec_form_edit_users_mob_event_login_onchange_cb_after_alert

  // ---------- Event onclick modelo_senha
  function do_ajax_sec_form_edit_users_mob_event_modelo_senha_onclick()
  {
    var var_sugestao_senha = scAjaxGetFieldHidden("sugestao_senha");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_sec_form_edit_users_mob_event_modelo_senha_onclick(var_sugestao_senha, var_script_case_init, do_ajax_sec_form_edit_users_mob_event_modelo_senha_onclick_cb);
  } // do_ajax_sec_form_edit_users_mob_event_modelo_senha_onclick

  function do_ajax_sec_form_edit_users_mob_event_modelo_senha_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "modelo_senha";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_sec_form_edit_users_mob_event_modelo_senha_onclick_cb_after_alert);
  } // do_ajax_sec_form_edit_users_mob_event_modelo_senha_onclick_cb
  function do_ajax_sec_form_edit_users_mob_event_modelo_senha_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_sec_form_edit_users_mob_event_modelo_senha_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_sec_form_edit_users_mob_submit_form()
  {
    ...
    var var_modelo_senha = scAjaxGetFieldCheckbox("modelo_senha", ";");
    var var_sugestao_senha = scAjaxGetFieldHidden("sugestao_senha");
    ...
    var var_mfa = scAjaxGetFieldText("mfa");
    var var_picture = scAjaxGetFieldText("picture");
    var var_data_senha = scAjaxGetFieldText("data_senha");
    var var_data_expirar_senha = scAjaxGetFieldText("data_expirar_senha");
    ...
    scAjaxProcOn();
    x_ajax_sec_form_edit_users_mob_submit_form(var_login, var_name, var_email, var_modelo_senha, var_sugestao_senha, var_pswd, var_confirm_pswd, var_active, var_mfa, var_picture, var_data_senha, var_data_expirar_senha, var_groups, var_picture_ul_name, var_picture_ul_type, var_picture_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_sec_form_edit_users_mob_submit_form_cb);
  ...
  function do_ajax_sec_form_edit_users_mob_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("modelo_senha");
      scAjaxHideErrorDisplay("sugestao_senha");
      scAjaxHideErrorDisplay("pswd");
      scAjaxHideErrorDisplay("confirm_pswd");
      scAjaxHideErrorDisplay("active");
      scAjaxHideErrorDisplay("mfa");
      scAjaxHideErrorDisplay("picture");
      scAjaxHideErrorDisplay("data_senha");
      scAjaxHideErrorDisplay("data_expirar_senha");
...
?>
  ...
  ajax_field_list[3] = "modelo_senha";
  ajax_field_list[4] = "sugestao_senha";
  ajax_field_list[5] = "pswd";
  ajax_field_list[6] = "confirm_pswd";
  ajax_field_list[7] = "active";
  ajax_field_list[8] = "mfa";
  ajax_field_list[9] = "picture";
  ajax_field_list[10] = "data_senha";
  ajax_field_list[11] = "data_expirar_senha";
  ajax_field_list[12] = "groups";
  ...
  var ajax_error_list = {
    ...
    "modelo_senha": {"label": "Sugestão de Senha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sugestao_senha": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "mfa": {"label": "Mfa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "picture": {"label": "Picture", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "data_senha": {"label": "Data Senha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "data_expirar_senha": {"label": "Data Expirar Senha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "name": new Array(),
    "email": new Array(),
    "modelo_senha": new Array(),
    "sugestao_senha": new Array(),
    "pswd": new Array(),
    "confirm_pswd": new Array(),
    "active": new Array(),
    "mfa": new Array(),
    "picture": new Array(),
    "data_senha": new Array(),
    "data_expirar_senha": new Array(),
    "groups": new Array()
  };
  ajax_field_mult["login"][1] = "login";
  ajax_field_mult["name"][1] = "name";
  ajax_field_mult["email"][1] = "email";
  ajax_field_mult["modelo_senha"][1] = "modelo_senha";
  ajax_field_mult["sugestao_senha"][1] = "sugestao_senha";
  ajax_field_mult["pswd"][1] = "pswd";
  ajax_field_mult["confirm_pswd"][1] = "confirm_pswd";
  ajax_field_mult["active"][1] = "active";
  ajax_field_mult["mfa"][1] = "mfa";
  ajax_field_mult["picture"][1] = "picture";
  ajax_field_mult["data_senha"][1] = "data_senha";
  ajax_field_mult["data_expirar_senha"][1] = "data_expirar_senha";
  ...
  var ajax_field_id = {
    ...
    "modelo_senha": new Array("hidden_field_label_modelo_senha", "hidden_field_data_modelo_senha"),
    "sugestao_senha": new Array("hidden_field_label_sugestao_senha", "hidden_field_data_sugestao_senha"),
    ...
    "mfa": new Array("hidden_field_label_mfa", "hidden_field_data_mfa"),
    "picture": new Array("hidden_field_label_picture", "hidden_field_data_picture"),
    "data_senha": new Array("hidden_field_label_data_senha", "hidden_field_data_data_senha"),
    "data_expirar_senha": new Array("hidden_field_label_data_expirar_senha", "hidden_field_data_data_expirar_senha"),
