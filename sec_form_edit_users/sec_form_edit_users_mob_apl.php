...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['data_expirar_senha']))
          {
              $this->data_expirar_senha = $this->NM_ajax_info['param']['data_expirar_senha'];
          }
          if (isset($this->NM_ajax_info['param']['data_senha']))
          {
              $this->data_senha = $this->NM_ajax_info['param']['data_senha'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['mfa']))
          {
              $this->mfa = $this->NM_ajax_info['param']['mfa'];
          }
          if (isset($this->NM_ajax_info['param']['modelo_senha']))
          {
              $this->modelo_senha = $this->NM_ajax_info['param']['modelo_senha'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['sugestao_senha']))
          {
              $this->sugestao_senha = $this->NM_ajax_info['param']['sugestao_senha'];
          }
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_edit_users_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_form_edit_users_mob']['label'] = "Usuários";
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'sec_form_edit_users/sec_form_edit_users_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'sec_form_edit_users_mob_calendar.php');
          }
          exit;
      }
...
//
      ...
      if (isset($this->mfa)) { $this->nm_limpa_alfa($this->mfa); }
      $Campos_Crit       = "";
      $Campos_erro       = "";
      $Campos_Falta      = array();
      $Campos_Erros      = array();
   ...
   function loadFieldConfig()
   {
      ...
      //-- data_senha
      $this->field_config['data_senha']                 = array();
      $this->field_config['data_senha']['date_format']  = $_SESSION['scriptcase']['reg_conf']['date_format'];
      $this->field_config['data_senha']['date_sep']     = $_SESSION['scriptcase']['reg_conf']['date_sep'];
      $this->field_config['data_senha']['date_display'] = "ddmmaaaa";
      $this->new_date_format('DT', 'data_senha');
      //-- data_expirar_senha
      $this->field_config['data_expirar_senha']                 = array();
      $this->field_config['data_expirar_senha']['date_format']  = $_SESSION['scriptcase']['reg_conf']['date_format'];
      $this->field_config['data_expirar_senha']['date_sep']     = $_SESSION['scriptcase']['reg_conf']['date_sep'];
      $this->field_config['data_expirar_senha']['date_display'] = "ddmmaaaa";
      $this->new_date_format('DT', 'data_expirar_senha');
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_modelo_senha' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'modelo_senha');
          }
          if ('validate_sugestao_senha' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'sugestao_senha');
          }
          ...
          if ('validate_mfa' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'mfa');
          }
          if ('validate_picture' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'picture');
          }
          if ('validate_data_senha' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'data_senha');
          }
          if ('validate_data_expirar_senha' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'data_expirar_senha');
          }
      ...
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          ...
          if ('event_modelo_senha_onclick' == $this->NM_ajax_opcao)
          {
              $this->modelo_senha_onClick();
          }
          sec_form_edit_users_mob_pack_ajax_response();
          exit;
      }
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          if (is_array($this->modelo_senha))
          {
              ...
              $this->modelo_senha = ""; 
              if ($this->modelo_senha_1 != "") 
              { 
                  foreach ($this->modelo_senha_1 as $dados_modelo_senha_1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->modelo_senha .= ";";
                      } 
                      $this->modelo_senha .= $dados_modelo_senha_1;
                      $x++ ; 
                  } 
              } 
          } 
          ...
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['dados_select']['sugestao_senha']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->sugestao_senha = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['dados_select']['sugestao_senha'];
          } 
...
<HEAD>
 <TITLE><?php echo strip_tags("Usuários") ?></TITLE>
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'data_senha':
               return "Data Senha";
               break;
           case 'data_expirar_senha':
               return "Data Expirar Senha";
               break;
           case 'groups':
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'modelo_senha' == $filtro)) || (is_array($filtro) && in_array('modelo_senha', $filtro)))
        $this->ValidateField_modelo_senha($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'sugestao_senha' == $filtro)) || (is_array($filtro) && in_array('sugestao_senha', $filtro)))
        $this->ValidateField_sugestao_senha($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'mfa' == $filtro)) || (is_array($filtro) && in_array('mfa', $filtro)))
        $this->ValidateField_mfa($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'data_senha' == $filtro)) || (is_array($filtro) && in_array('data_senha', $filtro)))
        $this->ValidateField_data_senha($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'data_expirar_senha' == $filtro)) || (is_array($filtro) && in_array('data_expirar_senha', $filtro)))
        $this->ValidateField_data_expirar_senha($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
//---
    ...
    function ValidateField_login(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      $this->login = sc_strtolower($this->login); 
...
;
    ...
    function ValidateField_modelo_senha(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
   if (isset($this->Field_no_validate['modelo_senha'])) {
       return;
   }
   if ($this->nmgp_opcao == "incluir")
   {
      if ($this->modelo_senha == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
      else 
      { 
          if (is_array($this->modelo_senha))
          {
              ...
              foreach ($this->modelo_senha as $ind => $dados_modelo_senha_1 ) 
              {
                  if ($dados_modelo_senha_1 != "") 
                  {
                      $this->modelo_senha_1[] = $dados_modelo_senha_1;
                  } 
              } 
              $this->modelo_senha = ""; 
              foreach ($this->modelo_senha_1 as $dados_modelo_senha_1 ) 
        ...
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'modelo_senha';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_modelo_senha

    function ValidateField_sugestao_senha(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['sugestao_senha'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (trim($this->sugestao_senha) != "")  
          { 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'sugestao_senha';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_sugestao_senha
   ...
   if (isset($this->Field_no_validate['active'])) {
    ...
    function ValidateField_mfa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if (isset($this->Field_no_validate['mfa'])) {
          return;
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->mfa) > 255) 
          { 
              $hasError = true;
              $Campos_Crit .= "Mfa " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['mfa']))
              {
                  $Campos_Erros['mfa'] = array();
              }
              $Campos_Erros['mfa'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['mfa']) || !is_array($this->NM_ajax_info['errList']['mfa']))
              {
                  $this->NM_ajax_info['errList']['mfa'] = array();
              }
              $this->NM_ajax_info['errList']['mfa'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_data_senha(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      nm_limpa_data($this->data_senha, $this->field_config['data_senha']['date_sep']) ; 
      if (isset($this->Field_no_validate['data_senha'])) {
          return;
      }
      $trab_dt_min = ""; 
      $trab_dt_max = ""; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $guarda_datahora = $this->field_config['data_senha']['date_format']; 
          if (false !== strpos($guarda_datahora, ';')) $this->field_config['data_senha']['date_format'] = substr($guarda_datahora, 0, strpos($guarda_datahora, ';'));
          $Format_Data = $this->field_config['data_senha']['date_format']; 
          nm_limpa_data($Format_Data, $this->field_config['data_senha']['date_sep']) ; 
          if (trim($this->data_senha) != "")  
          { 
              if ($teste_validade->Data($this->data_senha, $Format_Data, $trab_dt_min, $trab_dt_max) == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Data Senha; " ; 
                  if (!isset($Campos_Erros['data_senha']))
                  {
                      $Campos_Erros['data_senha'] = array();
                  }
                  $Campos_Erros['data_senha'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['data_senha']) || !is_array($this->NM_ajax_info['errList']['data_senha']))
                  {
                      $this->NM_ajax_info['errList']['data_senha'] = array();
                  }
                  $this->NM_ajax_info['errList']['data_senha'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
          $this->field_config['data_senha']['date_format'] = $guarda_datahora; 
       } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'data_senha';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_data_senha

    function ValidateField_data_expirar_senha(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      nm_limpa_data($this->data_expirar_senha, $this->field_config['data_expirar_senha']['date_sep']) ; 
      if (isset($this->Field_no_validate['data_expirar_senha'])) {
          return;
      }
      $trab_dt_min = ""; 
      $trab_dt_max = ""; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $guarda_datahora = $this->field_config['data_expirar_senha']['date_format']; 
          if (false !== strpos($guarda_datahora, ';')) $this->field_config['data_expirar_senha']['date_format'] = substr($guarda_datahora, 0, strpos($guarda_datahora, ';'));
          $Format_Data = $this->field_config['data_expirar_senha']['date_format']; 
          nm_limpa_data($Format_Data, $this->field_config['data_expirar_senha']['date_sep']) ; 
          if (trim($this->data_expirar_senha) != "")  
          { 
              if ($teste_validade->Data($this->data_expirar_senha, $Format_Data, $trab_dt_min, $trab_dt_max) == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Data Expirar Senha; " ; 
                  if (!isset($Campos_Erros['data_expirar_senha']))
                  {
                      $Campos_Erros['data_expirar_senha'] = array();
                  }
                  $Campos_Erros['data_expirar_senha'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['data_expirar_senha']) || !is_array($this->NM_ajax_info['errList']['data_expirar_senha']))
                  {
                      $this->NM_ajax_info['errList']['data_expirar_senha'] = array();
                  }
                  $this->NM_ajax_info['errList']['data_expirar_senha'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
          $this->field_config['data_expirar_senha']['date_format'] = $guarda_datahora; 
       } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'data_expirar_senha';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_data_expirar_senha
...
//--------------------------------------------------------------------------------------
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['modelo_senha'] = $this->modelo_senha;
    $this->nmgp_dados_form['sugestao_senha'] = $this->sugestao_senha;
    ...
    $this->nmgp_dados_form['data_senha'] = (strlen(trim($this->data_senha)) > 19) ? str_replace(".", ":", $this->data_senha) : trim($this->data_senha);
    $this->nmgp_dados_form['data_expirar_senha'] = (strlen(trim($this->data_expirar_senha)) > 19) ? str_replace(".", ":", $this->data_expirar_senha) : trim($this->data_expirar_senha);
   ...
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['data_senha'] = $this->data_senha;
      nm_limpa_data($this->data_senha, $this->field_config['data_senha']['date_sep']) ; 
      $this->Before_unformat['data_expirar_senha'] = $this->data_expirar_senha;
      nm_limpa_data($this->data_expirar_senha, $this->field_config['data_expirar_senha']['date_sep']) ; 
   }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if ((!empty($this->data_senha) && 'null' != $this->data_senha) || (!empty($format_fields) && isset($format_fields['data_senha'])))
      {
          nm_volta_data($this->data_senha, $this->field_config['data_senha']['date_format']) ; 
          nmgp_Form_Datas($this->data_senha, $this->field_config['data_senha']['date_format'], $this->field_config['data_senha']['date_sep']) ;  
      }
      elseif ('null' == $this->data_senha || '' == $this->data_senha)
      {
          $this->data_senha = '';
      }
      if ((!empty($this->data_expirar_senha) && 'null' != $this->data_expirar_senha) || (!empty($format_fields) && isset($format_fields['data_expirar_senha'])))
      {
          nm_volta_data($this->data_expirar_senha, $this->field_config['data_expirar_senha']['date_format']) ; 
          nmgp_Form_Datas($this->data_expirar_senha, $this->field_config['data_expirar_senha']['date_format'], $this->field_config['data_expirar_senha']['date_sep']) ;  
      }
      elseif ('null' == $this->data_expirar_senha || '' == $this->data_expirar_senha)
      {
          $this->data_expirar_senha = '';
      }
   }
...
//-- 
   ...
   {
      $guarda_format_hora = $this->field_config['data_senha']['date_format'];
      if ($this->data_senha != "")  
      { 
          nm_conv_data($this->data_senha, $this->field_config['data_senha']['date_format']) ; 
          $this->data_senha_hora = "00:00:00:000" ; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
          {
              $this->data_senha_hora = substr($this->data_senha_hora, 0, -4);
          }
      ...
      if ($this->data_senha == "" && $use_null)  
      { 
          $this->data_senha = "null" ; 
      } 
      $this->field_config['data_senha']['date_format'] = $guarda_format_hora;
      $guarda_format_hora = $this->field_config['data_expirar_senha']['date_format'];
      if ($this->data_expirar_senha != "")  
      { 
          nm_conv_data($this->data_expirar_senha, $this->field_config['data_expirar_senha']['date_format']) ; 
          $this->data_expirar_senha_hora = "00:00:00:000" ; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
          {
              $this->data_expirar_senha_hora = substr($this->data_expirar_senha_hora, 0, -4);
          }
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
          {
              $this->data_expirar_senha_hora = substr($this->data_expirar_senha_hora, 0, -4);
      ...
      if ($this->data_expirar_senha == "" && $use_null)  
      { 
          $this->data_expirar_senha = "null" ; 
      } 
      $this->field_config['data_expirar_senha']['date_format'] = $guarda_format_hora;
   }
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_modelo_senha();
          $this->ajax_return_values_sugestao_senha();
          $this->ajax_return_values_pswd();
          $this->ajax_return_values_confirm_pswd();
          $this->ajax_return_values_active();
          $this->ajax_return_values_mfa();
          $this->ajax_return_values_picture();
          $this->ajax_return_values_data_senha();
          $this->ajax_return_values_data_expirar_senha();
   ...
   function ajax_return_values_email($bForce = false)
   {
          ...
          //----- modelo_senha
   function ajax_return_values_modelo_senha($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("modelo_senha", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->modelo_senha);
              $aLookup = array();
              $this->_tmp_lookup_modelo_senha = $this->modelo_senha;

$aLookup[] = array(sec_form_edit_users_mob_pack_protect_string('Sim') => str_replace('<', '&lt;',sec_form_edit_users_mob_pack_protect_string("Sim")));
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['Lookup_modelo_senha'][] = 'Sim';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['modelo_senha']) && !empty($this->NM_ajax_info['select_html']['modelo_senha']))
          {
              $sOptComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['modelo_senha']);
          }
          $this->NM_ajax_info['fldList']['modelo_senha'] = array(
                       'row'    => '',
               'type'    => 'checkbox',
               'switch'  => true,
               ...
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-modelo_senha',
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['modelo_senha']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['modelo_senha']['valList'][$i] = sec_form_edit_users_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['modelo_senha']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['modelo_senha']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['modelo_senha']['labList'] = $aLabel;
          }
   }

          //----- sugestao_senha
   function ajax_return_values_sugestao_senha($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("sugestao_senha", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->sugestao_senha);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['sugestao_senha'] = array(
                       'row'    => '',
               'type'    => 'label',
               'valList' => array($sTmpValue),
              );
...
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['Lookup_active'][] = 'Y';
          ...
          //----- mfa
   function ajax_return_values_mfa($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("mfa", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->mfa);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['mfa'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
   ...
   { 
       ...
       $_SESSION['scriptcase']['sc_num_img']++ ; 
          ...
          //----- data_senha
   function ajax_return_values_data_senha($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("data_senha", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->data_senha);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['data_senha'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- data_expirar_senha
   function ajax_return_values_data_expirar_senha($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("data_expirar_senha", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->data_expirar_senha);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['data_expirar_senha'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
...
else
{
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      else
      {
          ...
          if (!isset($this->nmgp_cmp_hidden["modelo_senha"]))
          {
              $this->nmgp_cmp_hidden["modelo_senha"] = "off"; $this->NM_ajax_info['fieldDisplay']['modelo_senha'] = 'off';
          }
      }
...
$_SESSION['scriptcase']['sec_form_edit_users_mob']['contr_erro'] = 'off'; 
      ...
      $NM_val_form['modelo_senha'] = $this->modelo_senha;
      $NM_val_form['sugestao_senha'] = $this->sugestao_senha;
      ...
      $NM_val_form['data_senha'] = $this->data_senha;
      $NM_val_form['data_expirar_senha'] = $this->data_expirar_senha;
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          { 
              $this->data_senha = "null"; 
              $NM_val_null[] = "data_senha";
          } 
          if ($this->data_expirar_senha == "")  
          { 
              $this->data_expirar_senha = "null"; 
              $NM_val_null[] = "data_expirar_senha";
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
          { 
              if ($this->nmgp_opcao == "incluir")
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "\"name\" = '$this->name', email = '$this->email', active = '$this->active', mfa = '$this->mfa', data_senha = #$this->data_senha#, data_expirar_senha = #$this->data_expirar_senha#"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "\"name\" = '$this->name', email = '$this->email', active = '$this->active', mfa = '$this->mfa', data_senha = " . $this->Ini->date_delim . $this->data_senha . $this->Ini->date_delim1 . ", data_expirar_senha = " . $this->Ini->date_delim . $this->data_expirar_senha . $this->Ini->date_delim1 . ""; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "\"name\" = '$this->name', email = '$this->email', active = '$this->active', mfa = '$this->mfa', data_senha = EXTEND('$this->data_senha', YEAR TO DAY), data_expirar_senha = EXTEND('$this->data_expirar_senha', YEAR TO DAY)"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
             ...
             { 
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['mfa'])) { $this->mfa = $NM_val_form['mfa']; }
              elseif (isset($this->mfa)) { $this->nm_limpa_alfa($this->mfa); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('login', 'name', 'email', 'modelo_senha', 'sugestao_senha', 'pswd', 'confirm_pswd', 'active', 'mfa', 'picture', 'data_senha', 'data_expirar_senha', 'groups'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (login, pswd, \"name\", email, active, activation_code, priv_admin, mfa, picture, data_senha, data_expirar_senha) VALUES ('$this->login', '$this->pswd', '$this->name', '$this->email', '$this->active', '$this->activation_code', '$this->priv_admin', '$this->mfa', '$this->picture', #$this->data_senha#, #$this->data_expirar_senha#)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "login, pswd, \"name\", email, active, activation_code, priv_admin, mfa, picture, data_senha, data_expirar_senha) VALUES (" . $NM_seq_auto . "'$this->login', '$this->pswd', '$this->name', '$this->email', '$this->active', '$this->activation_code', '$this->priv_admin', '$this->mfa', '$this->picture', " . $this->Ini->date_delim . $this->data_senha . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->data_expirar_senha . $this->Ini->date_delim1 . ")"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "login, pswd, \"name\", email, active, activation_code, priv_admin, mfa, picture, data_senha, data_expirar_senha) VALUES (" . $NM_seq_auto . "'$this->login', '$this->pswd', '$this->name', '$this->email', '$this->active', '$this->activation_code', '$this->priv_admin', '$this->mfa', '$this->picture', " . $this->Ini->date_delim . $this->data_senha . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->data_expirar_senha . $this->Ini->date_delim1 . ")"; 
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "login, pswd, \"name\", email, active, activation_code, priv_admin, mfa, picture, data_senha, data_expirar_senha) VALUES (" . $NM_seq_auto . "'$this->login', '$this->pswd', '$this->name', '$this->email', '$this->active', '$this->activation_code', '$this->priv_admin', '$this->mfa', '$this->picture', EXTEND('$this->data_senha', YEAR TO DAY), EXTEND('$this->data_expirar_senha', YEAR TO DAY))"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "login, pswd, \"name\", email, active, activation_code, priv_admin, mfa, picture, data_senha, data_expirar_senha) VALUES (" . $NM_seq_auto . "'$this->login', '$this->pswd', '$this->name', '$this->email', '$this->active', '$this->activation_code', '$this->priv_admin', '$this->mfa', '$this->picture', " . $this->Ini->date_delim . $this->data_senha . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->data_expirar_senha . $this->Ini->date_delim1 . ")"; 
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['run_iframe'] == "R")
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['iframe_evento']) && $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
...
//---------- 
      ...
      { 
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
          { 
              $nmgp_select = "SELECT login, pswd, \"name\", email, active, activation_code, priv_admin, mfa, picture, str_replace (convert(char(10),data_senha,102), '.', '-') + ' ' + convert(char(8),data_senha,20), str_replace (convert(char(10),data_expirar_senha,102), '.', '-') + ' ' + convert(char(8),data_expirar_senha,20) from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT login, pswd, \"name\", email, active, activation_code, priv_admin, mfa, picture, convert(char(23),data_senha,121), convert(char(23),data_expirar_senha,121) from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $nmgp_select = "SELECT login, pswd, \"name\", email, active, activation_code, priv_admin, mfa, picture, data_senha, data_expirar_senha from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $nmgp_select = "SELECT login, pswd, \"name\", email, active, activation_code, priv_admin, mfa, picture, EXTEND(data_senha, YEAR TO DAY), EXTEND(data_expirar_senha, YEAR TO DAY) from " . $this->Ini->nm_tabela ; 
          } 
          else 
          { 
              $nmgp_select = "SELECT login, pswd, \"name\", email, active, activation_code, priv_admin, mfa, picture, data_senha, data_expirar_senha from " . $this->Ini->nm_tabela ; 
          ...
          { 
              ...
              $this->data_senha = $rs->fields[9] ; 
              $this->nmgp_dados_select['data_senha'] = $this->data_senha;
              $this->data_expirar_senha = $rs->fields[10] ; 
              $this->nmgp_dados_select['data_expirar_senha'] = $this->data_expirar_senha;
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
              { 
                  if (!empty($this->picture))
                  { 
      ...
      { 
          ...
          else
          {
              ...
              $this->nmgp_dados_form["picture"] = $this->picture;
              $this->data_senha = "";  
              $this->data_senha_hora = "" ;  
              $this->nmgp_dados_form["data_senha"] = $this->data_senha;
              $this->data_expirar_senha = "";  
              $this->data_expirar_senha_hora = "" ;  
              $this->nmgp_dados_form["data_expirar_senha"] = $this->data_expirar_senha;
              $this->groups = "";  
              $this->nmgp_dados_form["groups"] = $this->groups;
              $this->confirm_pswd = "";  
              $this->nmgp_dados_form["confirm_pswd"] = $this->confirm_pswd;
...
$original_data_expirar_senha = $this->data_expirar_senha;



$data = date('Y-m-d');

$this->data_expirar_senha  = date('Y-m-d', strtotime("+90 days",strtotime($data)));

$modificado_data_expirar_senha = $this->data_expirar_senha;
$this->nm_formatar_campos('data_expirar_senha');
if ($original_data_expirar_senha !== $modificado_data_expirar_senha || isset($this->nmgp_cmp_readonly['data_expirar_senha']) || (isset($bFlagRead_data_expirar_senha) && $bFlagRead_data_expirar_senha))
{
    $this->ajax_return_values_data_expirar_senha(true);
}
...
function modelo_senha_onClick()
{
$_SESSION['scriptcase']['sec_form_edit_users_mob']['contr_erro'] = 'on';
  
$original_sugestao_senha = $this->sugestao_senha;

$this->sugestao_senha  = $this->geraSenha(6, true, true, false);

$modificado_sugestao_senha = $this->sugestao_senha;
$this->nm_formatar_campos('sugestao_senha');
if ($original_sugestao_senha !== $modificado_sugestao_senha || isset($this->nmgp_cmp_readonly['sugestao_senha']) || (isset($bFlagRead_sugestao_senha) && $bFlagRead_sugestao_senha))
{
    $this->ajax_return_values_sugestao_senha(true);
}
...
$mail_smtp_server = 'mail.eaglesgroup.com.br';        
$mail_smtp_user = 'leocir@eaglesgroup.com.br';                   
$mail_smtp_pass = 'gl1Back5@';			
$mail_from = 'leocir@eaglesgroup.com.br';          
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function Form_lookup_modelo_senha()
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "Sim?#?Sim?#?N?@?";
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas["data_senha"] = "date";$Nm_datas["data_expirar_senha"] = "date";
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_form_edit_users_mob']['SC_sep_date1'];
              }
          }
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            ...
            case "delete":
                ...
                break;
            case "bcancelar":
                return array("sc_b_sai_t.sc-unique-btn-5", "sc_b_sai_t.sc-unique-btn-19");
                break;
            case "first":
                return array("sc_b_ini_t.sc-unique-btn-6", "sc_b_ini_t.sc-unique-btn-20");
                break;
            case "back":
                return array("sc_b_ret_t.sc-unique-btn-7", "sc_b_ret_t.sc-unique-btn-21");
                break;
            case "forward":
                return array("sc_b_avc_t.sc-unique-btn-8", "sc_b_avc_t.sc-unique-btn-22");
                break;
            case "last":
                return array("sc_b_fim_t.sc-unique-btn-9", "sc_b_fim_t.sc-unique-btn-23");
                break;
            case "help":
                return array("sc_b_hlp_t");
                break;
            case "exit":
                return array("sc_b_sai_t.sc-unique-btn-10", "sc_b_sai_t.sc-unique-btn-11", "sc_b_sai_t.sc-unique-btn-13", "sc_b_sai_t.sc-unique-btn-24", "sc_b_sai_t.sc-unique-btn-25", "sc_b_sai_t.sc-unique-btn-27", "sc_b_sai_t.sc-unique-btn-12", "sc_b_sai_t.sc-unique-btn-14", "sc_b_sai_t.sc-unique-btn-26", "sc_b_sai_t.sc-unique-btn-28");
                break;
        }
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "Usuários"; } else { echo "Usuários"; } ?></span></td>
