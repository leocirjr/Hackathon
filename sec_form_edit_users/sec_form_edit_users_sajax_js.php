...
?>
  ...
  function do_ajax_sec_form_edit_users_validate_modelo_senha()
  {
    var nomeCampo_modelo_senha = "modelo_senha";
    var var_modelo_senha = scAjaxGetFieldCheckbox(nomeCampo_modelo_senha, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_validate_modelo_senha(var_modelo_senha, var_script_case_init, do_ajax_sec_form_edit_users_validate_modelo_senha_cb);
  } // do_ajax_sec_form_edit_users_validate_modelo_senha

  function do_ajax_sec_form_edit_users_validate_modelo_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_validate_modelo_senha_cb

  // ---------- Validate sugestao_senha
  function do_ajax_sec_form_edit_users_validate_sugestao_senha()
  {
    var nomeCampo_sugestao_senha = "sugestao_senha";
    var var_sugestao_senha = scAjaxGetFieldHidden(nomeCampo_sugestao_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_validate_sugestao_senha(var_sugestao_senha, var_script_case_init, do_ajax_sec_form_edit_users_validate_sugestao_senha_cb);
  } // do_ajax_sec_form_edit_users_validate_sugestao_senha

  function do_ajax_sec_form_edit_users_validate_sugestao_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_validate_sugestao_senha_cb
  ...
  // ---------- Validate mfa
  function do_ajax_sec_form_edit_users_validate_mfa()
  {
    var nomeCampo_mfa = "mfa";
    var var_mfa = scAjaxGetFieldText(nomeCampo_mfa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_validate_mfa(var_mfa, var_script_case_init, do_ajax_sec_form_edit_users_validate_mfa_cb);
  } // do_ajax_sec_form_edit_users_validate_mfa

  function do_ajax_sec_form_edit_users_validate_mfa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mfa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_validate_mfa_cb
  ...
  // ---------- Validate data_senha
  function do_ajax_sec_form_edit_users_validate_data_senha()
  {
    var nomeCampo_data_senha = "data_senha";
    var var_data_senha = scAjaxGetFieldText(nomeCampo_data_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_validate_data_senha(var_data_senha, var_script_case_init, do_ajax_sec_form_edit_users_validate_data_senha_cb);
  } // do_ajax_sec_form_edit_users_validate_data_senha

  function do_ajax_sec_form_edit_users_validate_data_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_validate_data_senha_cb

  // ---------- Validate data_expirar_senha
  function do_ajax_sec_form_edit_users_validate_data_expirar_senha()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_form_edit_users_validate_data_expirar_senha(var_data_expirar_senha, var_script_case_init, do_ajax_sec_form_edit_users_validate_data_expirar_senha_cb);
  } // do_ajax_sec_form_edit_users_validate_data_expirar_senha

  function do_ajax_sec_form_edit_users_validate_data_expirar_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_form_edit_users_validate_data_expirar_senha_cb
  ...
  function do_ajax_sec_form_edit_users_event_login_onchange()
  {
    var var_data_expirar_senha = scAjaxGetFieldText("data_expirar_senha");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_sec_form_edit_users_event_login_onchange(var_data_expirar_senha, var_script_case_init, do_ajax_sec_form_edit_users_event_login_onchange_cb);
  } // do_ajax_sec_form_edit_users_event_login_onchange

  function do_ajax_sec_form_edit_users_event_login_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "login";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_sec_form_edit_users_event_login_onchange_cb_after_alert);
  } // do_ajax_sec_form_edit_users_event_login_onchange_cb
  function do_ajax_sec_form_edit_users_event_login_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_sec_form_edit_users_event_login_onchange_cb_after_alert

  // ---------- Event onclick modelo_senha
  function do_ajax_sec_form_edit_users_event_modelo_senha_onclick()
  {
    var var_sugestao_senha = scAjaxGetFieldHidden("sugestao_senha");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_sec_form_edit_users_event_modelo_senha_onclick(var_sugestao_senha, var_script_case_init, do_ajax_sec_form_edit_users_event_modelo_senha_onclick_cb);
  } // do_ajax_sec_form_edit_users_event_modelo_senha_onclick

  function do_ajax_sec_form_edit_users_event_modelo_senha_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "modelo_senha";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_sec_form_edit_users_event_modelo_senha_onclick_cb_after_alert);
  } // do_ajax_sec_form_edit_users_event_modelo_senha_onclick_cb
  function do_ajax_sec_form_edit_users_event_modelo_senha_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_sec_form_edit_users_event_modelo_senha_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_sec_form_edit_users_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_sec_form_edit_users_submit_form(var_login, var_name, var_email, var_modelo_senha, var_sugestao_senha, var_pswd, var_confirm_pswd, var_active, var_mfa, var_picture, var_data_senha, var_data_expirar_senha, var_groups, var_picture_ul_name, var_picture_ul_type, var_picture_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_sec_form_edit_users_submit_form_cb);
